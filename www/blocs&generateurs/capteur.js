...
Blockly.Blocks['inter']={init:function() {
    this.appendValueInput("pin")
        .setCheck("Number")
        .appendField(new Blockly.FieldImage('media/switch.png', 48, 48, "*"))
...
Blockly.Blocks["grove_ldr"]={init:function(){
	...
	if (prog != "python") {
		this.appendDummyInput().appendField(new Blockly.FieldImage('media/light.png', 48, 48, "*"))
...
Blockly.Blocks["inout_bp"]={init:function(){
        this.appendValueInput("PIN", "Number").appendField(new Blockly.FieldImage('media/button.png', 48, 48, "*"))
...
Blockly.Blocks["dht11"]={init:function(){
        this.appendValueInput("PIN", "Number").appendField(new Blockly.FieldImage('media/humidity11.png', 48, 48, "*"))
...
Blockly.Blocks["dht22"]={init:function(){
        this.appendValueInput("PIN", "Number").appendField(new Blockly.FieldImage('media/humidity22.png', 48, 48, "*"))
			.appendField(new Blockly.FieldDropdown(Blockly.Msg.menudht), "choix").appendField(Blockly.Msg.pin);
        this.setColour("#2a93e8");
        this.setHelpUrl("http://nagashur.com/blog/2013/06/18/lire-la-valeur-dune-sonde-de-temperature-et-d%E2%80%99hygrometrie-dht11/");
        this.setOutput(true, "Number");
...
Blockly.Blocks["suiveur_ligne"]={init:function(){
        this.appendValueInput("PIN", "Number").appendField(new Blockly.FieldImage('media/linefollow.png', 48, 48, "*"))
...
Blockly.Blocks["potentiometre"]={init:function(){
	...
	var prog = window.localStorage.prog;
	if (prog != "python") {
        this.appendDummyInput().appendField(new Blockly.FieldImage('media/potentiometer.png', 48, 48, "*"))
...
Blockly.Blocks['block_pir']={init:function(){
    this.appendValueInput("NAME")
        .setCheck("Number")
        .appendField(new Blockly.FieldImage('media/pir.png', 48, 48, "*"))
...
Blockly.Blocks['block_feu']={init:function(){
    this.appendValueInput("FEU")
        .setCheck("Number")
        .appendField(new Blockly.FieldImage('media/flame.png', 48, 48, "*"))
...
Blockly.Blocks["cap615"]={init:function(){
	...
	var prog = window.localStorage.prog;
	if (prog != "python") {
        this.appendDummyInput().appendField(new Blockly.FieldImage('media/soil.png', 48, 48, "*"))
