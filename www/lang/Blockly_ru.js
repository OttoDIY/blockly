...
Blockly.Msg.INOUT_HIGH_LEVEL = "1(высокое напряжение)";
Blockly.Msg.INOUT_LOW_LEVEL = "0(низкое напряжение)";
Blockly.Msg.ARD_TYPE_CHAR = "символьный";
Blockly.Msg.ARD_TYPE_TEXT = "текстовый";
Blockly.Msg.ARD_TYPE_BOOL = "двоичный";
...
Blockly.Msg.ARD_TYPE_UNDEF = "не определенный";
Blockly.Msg.ARD_TYPE_VOLATILE = "volatile integer";
Blockly.Msg.ARD_TYPE_CHILDBLOCKMISSING = "без указания в блоке";
Blockly.Msg.ARDUINO_BETWEEN = "случайный диапазон";
Blockly.Msg.ARDUINO_BETWEEN_AND = "и";
Blockly.Msg.ARDUINO_VAR_DECLARE="состояние";
Blockly.Msg.ARDUINO_VAR_AS = "так как";
Blockly.Msg.ARDUINO_VAR_VAL = "параметр";
Blockly.Msg.base_def_const = "задать";
Blockly.Msg.base_define_const = "эквивалентно";
Blockly.Msg.base_define_const_tooltip = "позволяет программисту давать имя любому значению";
Blockly.Msg.type = "установить значение выбранного типа";
...
Blockly.Msg.COLLAPSE_ALL = "Уменьшить блоки";
Blockly.Msg.COLLAPSE_BLOCK = "Уменьшить блок";
Blockly.Msg.CONTROLS_SWITCH_VAR_TITLE = "Пока";
Blockly.Msg.CONTROLS_SWITCH_MSG_DEFAULT = "по умолчанию";
Blockly.Msg.CONTROLS_SWITCH_MSG_CASEBREAK = "находится";
Blockly.Msg.CONTROLS_SWITCH_MSG_SWITCHVAR = "если переменная действительна";
...
Blockly.Msg.ARRAY_CREATE_WITH_CONTAINER_TOOLTIP = "Добавить,Удалить и Переназначить";
