...
Blockly.Msg.CAT_MAX7219 = "💡 配列 8x8";
Blockly.Msg.CAT_MAX1640 = "💡 配列 16x8";
...
Blockly.Msg.RTCDS3231_RTC="⏲️ 日付と時間のせってい ";
...
Blockly.Msg.matrice = "マトリックス";
Blockly.Msg.matrice8x8_tooltip = "64 の LEDs マトリックスを初期化。　どのピンが DIN, CLK, CS につながるか arduino に伝える必要があります。 ";
Blockly.Msg.matrice8x8_symbole = "シンボルを定義（ていぎ）";
Blockly.Msg.matrice8x8_symbole_tooltip = "マトリックスのシンボルを定義: \n 0 LED をオフ an LED \n 1 LED をオン";
Blockly.Msg.matrice8x8_efface = "マトリックスを消す";
Blockly.Msg.matrice8x8_aff = "シンボルを表示（ひょうじ）する";
Blockly.Msg.matrice8x8_binaire_tooltip = "1 でマトリックスの LED を オン、0 でオフ";
...
Blockly.Msg.matrice8x8_efface_tooltip = "マトリックスのすべての LED をオフ";
Blockly.Msg.matrice16x8_tooltip = "128 の LED を初期化する。 \nマトリックス <-> Arduino \nSDA <--------> A4 \nSCL <--------> A5";
Blockly.Msg.matrice16x8_symbole = "シンボルを定義（ていぎ）";
Blockly.Msg.matrice16x8_symbole_tooltip = "マトリックスのためのシンボルの定義（ていぎ）: \n 0 LED をオフ \n 1 LED をオン";
Blockly.Msg.matrice16x8_efface = "マトリックスの LED を消す";
Blockly.Msg.matrice16x8_aff = "シンボルを表示（ひょうじ）する";
Blockly.Msg.matrice16x8_binaire_tooltip = "1 マトリックスの LED をつける。 0 マトリックスの LED を消す";
...
Blockly.Msg.matrice16x8_efface_tooltip = "マトリックスのすべての LED を消す";
//time
