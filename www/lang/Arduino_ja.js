...
Blockly.Msg.CAT_ARDUINO_OUT = "↪️ 終わる";
...
Blockly.Msg.RTCDS3231_RTC="⏲️ 日付と時間の設定（せってい） ";
...
Blockly.Msg.RTCDS3231_READ_RTC="⏲️ RTC 日付と時間の読みこみ";
Blockly.Msg.RTCDS3231_VALUES="値（あたい）";
...
//Wireless
Blockly.Msg.esp8266_init_tooltip = "あたえられたパラメータで wifi モジュールの初期化とせつぞく";
...
//INTERRUPTION
Blockly.Msg.LKL_ATTACHINTERRUPT_PIN = '割込み（わりこみ）: もし ';
Blockly.Msg.LKL_DETACHINTERRUPT_PIN = "割込み（わりこみ）信号を無効（むこう）に　ピン";
Blockly.Msg.LKL_TOOLTIP_INOUT_ATTACHINTERRUPT = "ピン 2 か 3 に発生した外部割込み（４つのモードをサポート）に対するアクションを指定";
Blockly.Msg.LKL_TOOLTIP_INOUT_DETACHINTERRUPT = "先に指定された外部わりこみを無効（むこう）にする";
Blockly.Msg.LKL_MODE = 'が次のピンで発生';
// FIELDDROPDOWN
...
Blockly.Msg.FIELDDROPDOWN_ONOFF = [["有効（ゆうこう）", Blockly.Msg.high], ["無効（むこう）", Blockly.Msg.low]];
...
Blockly.Msg.menudht = [["💧湿度（しつど）", "h"], ["🌡️温度", "t"]];
...
Blockly.Msg.VL53L0X_distance="距離（きょり） (mm)";
Blockly.Msg.VL53L0X_distance_tooltip="VL530X :\n距離（きょり）をミリメートルで返す";
Blockly.Msg.bme280="大気圧（たいきあつ） ピン I²C";
Blockly.Msg.bme280_tooltip="BME280 センサーを初期化。\nSensor <--> Arduino\nSDA <--------> A4\nSCL <--------> A5";
Blockly.Msg.bme280_pressure="大気圧（たいきあつ） (hPa)";
...
Blockly.Msg.mc005="次のピンにつながっている";
Blockly.Msg.mc005_tooltip="MC005:\nつながっていれば true つながっていなければ false を返す";
Blockly.Msg.bp = "次のピンでボタンがおされているか調べる";
Blockly.Msg.bp_tooltip = "プッシュボタンがおされていれば true を押されていなければ false を返す";
...
Blockly.Msg.light = "輝度（きど） ピン";
Blockly.Msg.light_tooltip = "輝度（きど）に応じた数字を返す \n0: まっくら \n255: 最大の明るさ";
Blockly.Msg.hum = "含水率（がんすいりつ） ピン";
Blockly.Msg.hum_tooltip = "CAP 615: \n含水率（がんすいりつ）を 0 から 100% で返す";
Blockly.Msg.light_tooltip = "returns a value depending on the brightness \n0: darkness \n255: full light";
Blockly.Msg.grove_ldr = "輝度（きど） ピン";
Blockly.Msg.grove_ldr_tooltip = "輝度（きど）を返す \n0: あかりなし \n100: とても強いあかり";
Blockly.Msg.potar = "カーソルポジション ピン";
Blockly.Msg.potar_tooltip = "カーソルの場所を数字で返す \n0: カーソル左 \n255: カーソル右";
Blockly.Msg.lm35 = "温度　ピン";
Blockly.Msg.lm35_tooltip = "LM35: \n温度を返す (0 ～ 80 �)";
Blockly.Msg.ultrason_1 = "距離（きょり） < リミット";
Blockly.Msg.ultrason_2 = "もし距離（きょり）がセンサーのリミットより短かったら High ステータスを返す";
Blockly.Msg.ultrason_distance1 = "距離（きょり） (cm)";
Blockly.Msg.ultrason_tooltip = "HC-SR04: \n距離（きょり）調べる超音波（ちょおんぱ）センサー (3cm ～ 400cm)\nindicate the pins of the Arduino to which will be connected TRIG and ECHO";
Blockly.Msg.ultrason = "超音波（ちょうおんぱ）　ピン";
Blockly.Msg.ultrason_distance2 = "HC-SR04: \n超音波（ちょうおんぱ）センサーで計測（けいそく）した距離（きょり）をセンチメートルで返す";
Blockly.Msg.pir = "動きを検出（けんしゅつ） ";
Blockly.Msg.feu = "火を検出（けんしゅつ） ";
Blockly.Msg.presence = "障害物（しょうがいぶつ）を検出（けんしゅつ） ";
Blockly.Msg.appui = "タッチ ";
Blockly.Msg.pir_tooltip = "HC-SR501: \n動きを検出（けんしゅつ）すれば（しなければ） true (false) を返す";
Blockly.Msg.feu_tooltip = "CAP168: \n火を検出（けんしゅつ）すれば（しなければ） true (false) を返す";
...
Blockly.Msg.LCDi2c_tooltip = "2 行 16　文字で RGB バックライトの I²C LCD を初期化。 \n Displayer <-> Arduino \nSDA <--------> A4 \nSCL <- -------> A5 ";
Blockly.Msg.LCD_tooltip = "2 行 16　文字の LCD を初期化、 ピンにつながっていることを通知";
Blockly.Msg.LCD_SHIELD_PRINT_HELPURL = "https://www.arduino.cc/en/Tutorial/HelloWorld";// do not translate
Blockly.Msg.LCD_SHIELD_PRINT_TEXT = "表示（ひょうじ）";
Blockly.Msg.LCD_SHIELD_PRINT_TEXT_tooltip = "指定の場所に文字を表示（ひょうじ）";
...
Blockly.Msg.lcd_aff_symbole = "シンボルを表示（ひょうじ）";
Blockly.Msg.lcd_aff_symbole_tooltip = "あらかじめ定義（ていぎ）されたシンボルを表示（ひょうじ）";
Blockly.Msg.lcd_symbole = "シンボルを定義（ていぎ）";
Blockly.Msg.lcd_symbole_tooltip = "LCD のためのキャラクターの定義（ていぎ）: \n 0 ピクセルをオフ a pixel \n 1 ピクセルをオン";
// structure
Blockly.Msg.loop = "🔄 ループ";
Blockly.Msg.init = "⚙️ セットアップ";
Blockly.Msg.base_setup_loop = "セットアップ: \n変数の初期化、ピンの向きの初期化などを行います。 ... \n一度だけ実行されます。 \nループ: \nプログラムのメインとなる部分で、ここに配置されたすべてのブロックがむげんにループします（1秒間に数千回）";
Blockly.Msg.loop_tooltip = "ここに置かれたブロックはいつまでもくり返し（１秒間に数千回）実行されます";
Blockly.Msg.begin_tooltip = "このブロックはプログラムの実行の順番をしめすために使います";
Blockly.Msg.begin = "🏁 スタート";
Blockly.Msg.def = "⚙️ 宣言（せんげん）";
Blockly.Msg.def_tooltip = "ここに置かれたブロックは一度だけ実行されます。ここでセンサーやアクチュエータの設定（せってい）を行います";
Blockly.Msg.END = "🏁 終わり";
Blockly.Msg.END_tooltip = "プログラムの終わり。ここから後のブロックは実行されません";
Blockly.Msg.code_tooltip = "ブロックでは用意されてない処理（しょり）をここに書きます";
//matrix
Blockly.Msg.matriceLC = "LED X";
Blockly.Msg.matrice_create_aff = "ブロックを作る 'シンボル %1 を表示（ひょうじ）する'";
Blockly.Msg.matrice_create_symbole = "ブロックを作る 'シンボル %1 をセットする'";
Blockly.Msg.matrice = "行列";
Blockly.Msg.matrice8x8_tooltip = "64 の LEDs 行列を初期化。　どのピンが DIN, CLK, CS につながるか arduino に伝える必要があります。 ";
Blockly.Msg.matrice8x8_symbole = "シンボルを定義（ていぎ）";
Blockly.Msg.matrice8x8_symbole_tooltip = "シンボルの行列を定義: \n 0 LED をオフ an LED \n 1 LED をオン";
Blockly.Msg.matrice8x8_efface = "LED 行列を消す";
Blockly.Msg.matrice8x8_aff = "シンボルを表示（ひょうじ）する";
...
Blockly.Msg.matrice8x8_aff_tooltip = "すでに定義（ていぎ）されたシンボルを表示";
Blockly.Msg.matrice8x8_efface_tooltip = "行列の中のすべての LED をオフ";
Blockly.Msg.matrice16x8_tooltip = "128 の LED を初期化する。 \n行列 <-> Arduino \nSDA <--------> A4 \nSCL <--------> A5";
Blockly.Msg.matrice16x8_symbole = "シンボルを定義（ていぎ）";
Blockly.Msg.matrice16x8_symbole_tooltip = "シンボルの行列の定義（ていぎ）: \n 0 LED をオフ \n 1 LED をオン";
Blockly.Msg.matrice16x8_efface = "行列の LED を消す";
Blockly.Msg.matrice16x8_aff = "シンボルを表示（ひょうじ）する";
...
Blockly.Msg.matrice16x8_aff_tooltip = "すでに定義（ていぎ）されたシンボルを表示";
...
Blockly.Msg.ARDUINO_INOUT_Pulsein = "ピンに UP または DOWN のパルスが来るまでの時間をミリ秒で返す。パラメータが HIGH の場合このブロックはピンが HIGH になるまで待ち、タイマーを開始、また LOW に戻ったらそれまでにかかった時間を返します。 ";
...
Blockly.Msg.millis1 = "かかった時間　単位";
Blockly.Msg.millis2 = "初めから";
Blockly.Msg.ARDUINO_SINCE_PROGRAM_STARTED_TOOLTIP = "プログラムが開始してからここまででかかった時間を ミリ秒、秒、マイクロ秒のいずれかで返す";
Blockly.Msg.ARDUINO_PULSEIN = "ピンのステータスが変わる時間";
Blockly.Msg.tempo_helpurl = "https://www.arduino.cc/en/tutorial/blink";// do not translate
Blockly.Msg.tempo_tooltip = "このブロックは指定された時間がすぎているか調べて、もしすぎていれば中のブロックを実行します。　もしまだすぎていなければ、このブロックは時間が来るまで待つのではなく、中のブロックを実行せずにそのまま次に進みます。" ;
Blockly.Msg.tempo1 = "すべて";

// LED
Blockly.Msg.ARDUINO_INOUT_BUILDIN_LED_INPUT = "💡 ボードの LED";
Blockly.Msg.ARDUINO_INOUT_BUILDIN_LED_TOOLTIP = "Arduino ボードの LED を つける、または消す";
Blockly.Msg.blink = "💡 ボードの LED を点滅（てんめつ）";
Blockly.Msg.blink_tooltip = "ボードの LED を1 秒間に１回、または 10 回点滅（てんめつ）さえる";
Blockly.Msg.del = "💡 LED ピン";
Blockly.Msg.del_tooltip = "指定されたピンにつながっている LED をオン（オフ）";
Blockly.Msg.bargraphe = "バーグラフ";
Blockly.Msg.bargraphe_allume="LED をつける";
Blockly.Msg.bargraphe_allume_tooltip="0 ついている LEDs なし \n2.5 2 つ LEDs をつけて、３番目は半分の明るさでつける \n10 全ての LED をつける";
Blockly.Msg.bargraphe_tooltip = "10 この LED のバーグラフ (8 この緑、1 この黄、1 つの赤)。 arduno のどのピンと DCKI、DI がつながっているかしめす必要があります";
Blockly.Msg.rvb_init="LED RGB ピン";
Blockly.Msg.rvb_init_tooltip="PWM ピンに RGB LED とつながっていることをしめす";
Blockly.Msg.rvb_set="🚥 色を表示（ひょうじ）";
Blockly.Msg.rvb_set_tooltip="3 原色（赤、緑、青）で色を表示（ひょうじ）する";
Blockly.Msg.pixel1 = "NeoPixel";
Blockly.Msg.pixel2 = "🌈 ピクセルを表示（ひょうじ）";
Blockly.Msg.pixel3 = "色";
Blockly.Msg.pixel4 = "# のピクセル";
Blockly.Msg.pixel5 = "🌈 ピクセルの明るさを設定（せってい）";
Blockly.Msg.pixel6 = "🌈 ピクセル #";
Blockly.Msg.pixel1_tooltip="neopixel RGB モジュールがピンにつながっているピンとピクセルの数をしめす";
Blockly.Msg.pixel2_tooltip="変更した内容で表示（ひょうじ）";
Blockly.Msg.pixel5_tooltip="ピクセルの明るさを設定（せってい） (0 ～ 255)";
Blockly.Msg.pixel3_tooltip="ピクセルの色を選ぶ \ n注意：番号は 0 から始まります";
// output
Blockly.Msg.ARDUINO_INOUT_DIGITAL_WRITE_INPUT1 = "書き込み デジタルピン";
Blockly.Msg.ARDUINO_INOUT_DIGITAL_WRITE_TOOLTIP = "指定のピンを論理状態（ろんりじょうたい）の 0 または 1 にする";
Blockly.Msg.toggle = "ピンの状態（じょうたい）をトグル";
Blockly.Msg.toggle_tooltip = "トグル: \n もし論理状態（ろんりじょうたい）1 ならば 0 に、0 ならば 1 に出力の状態（じょうたい）を変える";
Blockly.Msg.ARDUINO_INOUT_ANALOG_WRITE_INPUT1 = "アナログ PWM ピンに書きこむ";
Blockly.Msg.ARDUINO_INOUT_ANALOG_WRITE_TOOLTIP = "アナログの出力 0 ～ 255 を指定のピンに送る";
// input
Blockly.Msg.ARDUINO_INOUT_DIGITAL_READ_INPUT = "デジタル状態（じょうたい）を読む ピン";
Blockly.Msg.in_pullup = "プルアップ";
Blockly.Msg.in_pullup_tooltip = "ピンの論理状態（ろんりじょうたい）（0 または 1) を返す。 \nプルアップが有効（ゆうこう）になっている場合、デフォルトで 1 (HIGH) を返します。";
Blockly.Msg.ARDUINO_INOUT_DIGITAL_READ_TOOLTIP = "デジタルピンの論理状態（0 または1）を読む";
Blockly.Msg.ARDUINO_INOUT_ANALOG_READ_INPUT = "ピンのアナログ値（あなろぐち）を読む ";
Blockly.Msg.ARDUINO_INOUT_ANALOG_READ_TOOLTIP = "0 から 1023 の値を返す";
// audio
Blockly.Msg.play = "再生（さいせい）";
...
Blockly.Msg.ARDUINO_RTTTL_BLOCK = "リングトーンを再生（さいせい）";
...
Blockly.Msg.lp2i_mp3_play = "▶️ MP3を再生（さいせい）";
Blockly.Msg.lp2i_mp3_play_track_tooltip = "▶️ トラックソングファイル 0～2999 から指定のものを再生（さいせい）";
Blockly.Msg.lp2i_mp3_play_tooltip = "▶️ 現在のソングファイルを再生（さいせい）";
Blockly.Msg.lp2i_mp3_pause = "⏸️ MP3 を一時停止（いちじていし）";
Blockly.Msg.lp2i_mp3_pause_tooltip = "現在のソングファイルの再生（さいせい）を一時停止（いちじていし）する";
...
Blockly.Msg.m_pap_tooltip = "ステッピングモーターの初期化。 \nステップ数、回転数（rpm）、接続（せつぞく）するピンをしめす";
Blockly.Msg.m_pap_step_tooltip = "ステッピングモーターを指定されたステップ数だけ作動させる。 次の命令は、モーターの回転が終わってから実行されます。";
// serial
...
Blockly.Msg.SSERIAL_Read_tooltip = "ソフトウェアシリアルポートに送られたデータの最初のデータバイトを返します。データがない場合は-1を返します。";
...
Blockly.Msg.OTTO9_HOME_TOOLTIP = "Otto をまっすぐのポジションにする";
Blockly.Msg.OTTO9_BUZZER="🎼 ブザー";
Blockly.Msg.OTTO_HOME_TEXT = "ピン";
Blockly.Msg.OTTO9_DIY_URL = "https://www.ottodiy.com/academy";// do not translate
Blockly.Msg.OTTO9_CALIBRATION='キャリブレーション ';
Blockly.Msg.OTTO9_CALIBRATION_LEG='足のつけね ';
Blockly.Msg.OTTO9_CALIBRATION_FOOT='足 ';
Blockly.Msg.OTTO9_CALIBRATION_TOOLTIP='小さな正負のあたいをくりかえして試して、完全に直線（90º）になるまで少しずつに変化させる。';
Blockly.Msg.OTTO9_EEPROM_TEXT= 'トリムをEEPROMに保存（ほぞん）';
Blockly.Msg.OTTO9_EEPROM_TOOLTIP= '完全に直進（90°）した後にのみ使用し、その後のプログラミングではこのブロックを消してください。';
Blockly.Msg.OTTO9_MOVE_TEXT = "動く";
Blockly.Msg.OTTO9_MOVE_TOOLTIP = "Otto の基本動作をします";
...
Blockly.Msg.OTTO9_MOVE_SPEED_CHOICE = [["ノーマル", "1000"],["スロー", "2000"],["ベリースロー", "3000"] , ["速い", "750"], ["すごく速い", "500"], ["さらに速い", "250"]];
Blockly.Msg.OTTO9_MOVEW_SPEED_CHOICE = [["ノーマル", "45"],["スロー", "20"],["ベリースロー", "10"] , ["速い", "60"], ["すごく早い", "90"]];
...
Blockly.Msg.OTTO9_DO_TOOLTIP = "Otto のふくざつな動作";
...
Blockly.Msg.OTTO9_GESTURE_TOOLTIP = "感情（かんじょう）を表した音と動きの組み合わせ";
Blockly.Msg.OTTO9_GESTURE_CHOICE = [["😃 ハッピー１", "OttoSuperHappy"],["🙂 ハッピー２", "OttoHappy"], ["🙁 悲しい", "OttoSad"], ["😴 ねむり", "OttoSleeping"], ["😕 混乱（こんらん）", "OttoConfused"], ["😰 気が重い", "OttoFretful"], ["😍 愛", "OttoLove"], ["😡 いかり", "OttoAngry"], ["🤩 マジック", "OttoMagic"], ["😐 ウェーブ", "OttoWave"], [" 😎 勝利", "OttoVictory"], ["😞 失敗", "OttoFail"], ["💩 おなら", "OttoFart"]];
Blockly.Msg.OTTO9_SOUND_TEXT = "音";
Blockly.Msg.OTTO9_SOUND_TOOLTIP = "感情（かんじょう）を表した音";
Blockly.Msg.OTTO9_SOUND_CHOICE = [ ["😃 ハッピー１", "S_superHappy"], ["🙂 ハッピー２", "S_happy"], ["😊 ハッピー３", "S_happy_short"], ["🙁 悲しい", "S_sad"], ["😕 混乱（こんらん）", "S_confused"], ["🤗 かわいい", "S_cuddly"], ["😮 あら", "S_OhOoh"], ["😯 あらあら", "S_OhOoh2"], ["😲 びっくり", "S_surprise"],["🤖 つながり", "S_connection"], [" 🤖 つながってない", "S_disconnection"], ["👇 プッシュ", "S_buttonPushed"], ["❗ 1", "S_mode1"], ["❗❗ 2", "S_mode2"], ["❗❗❗ 3", "S_mode3"], ["💤 スリープ", "S_sleeping"], ["💩 おなら１", "S_fart1"], ["💩 おなら２", "S_fart2"], ["💩 おなら３", "S_fart3"],];
Blockly.Msg.OTTO9_GETDISTANCE_TEXT = "距離 [cm]";
Blockly.Msg.OTTO9_GETDISTANCE_TOOLTIP = "ピントリガー 8 ピンエコー 9. 2cm～400cmの測距距離（そくていきょり）";
Blockly.Msg.OTTO9_GETOBSTACLE_TEXT = "障害物（しょうがいぶつ）";
Blockly.Msg.OTTO9_OBSTACLE_CHOICE = [["近い", "10"],["すごく近い", "3"],["遠い", "30"]];
Blockly.Msg.OTTO9_GETNOISE_TEXT = "ノイズ検出（けんしゅつ）";
...
Blockly.Msg.OTTO9_GETG_TEXT2 = "値（あたい）";
Blockly.Msg.OTTO9_MOUTH_TEXT = "口";
Blockly.Msg.OTTO9_MOUTH_TOOLTIP = "8x8 LED 行列での口の感情 #0-30";
Blockly.Msg.OTTO9_MOUTH_CHOICE = [["😃 ハッピー１", "happyOpen"],["🙂 ハッピー２", "happyClosed"], ["😊 笑顔", "smile"], ["😦 悲しい１", "23"], ["🙁 悲しい２", "24"], ["😮 おどろいた", "smallSurprise"], ["😲 おどろいた２", "bigSurprise"], ["😕 混乱（こんらん）", "confused"],["😛 べろ", "tongueOut"],["🙃 ばか", "culito"],  ["😑 まじめ", "lineMouth"], ["🙄 動揺（どうよう）", "21"], ["💖 ハート", "heart"], ["🦇 v1", "vamp1"], ["🦇 v2", "vamp2"], ["❌ ノー", "xMouth"], ["✅ オッケー", "okMouth"],["❓?", "27"], ["⚡ かみなり", "thunder"]];
Blockly.Msg.OTTO9_MATRIX_TOOLTIP = "ピン：DIN A3, CS A2, CLK A1。 表示（ひょうじ）できる文字は大文字 A～Z 数字 0～9 : ; < > = @, 最大9文字";
...
Blockly.Msg.OTTO9_EYES_CHOICE = [["😃 ハッピー１", "happy_bmp"],["🙂 ハッピー２", "eyes_bmp"], ["😦 悲しい", "sad_bmp"], ["😡 いかり１", "angry_bmp"], ["😡 いかり２", "angry2_bmp"], ["😰 気が重い", "freetful_bmp"], ["😕 混乱（こんらん）", "confused_bmp"],["😴 ねむり", "sleep_bmp"],["😍 愛", "love_bmp"],  ["😑 ウェーブ", "wave_bmp"], ["🤩 マジック", "magic_bmp"], ["😞 失敗", "fail_bmp"], ["🤖 ロゴ", "logo_bmp"], ["❌❌ ノー", "XX_bmp"], ["x x", "xx_bmp"],["▉", "full_bmp"]];
...
Blockly.Msg.OTTO9_ARMS_TEXT = "腕（うで）";
Blockly.Msg.OTTO9_ARMS_TOOLTIP = "腕（うで）を動かす！";
Blockly.Msg.OTTO9_ARMS_CHOICE = [["手をあげる", "HANDSUP"],["手を下げる", "HANDSDOWN"], ["左手をふる", "HANDWAVE1"], ["右手をふる", "HANDWAVE2"]];
