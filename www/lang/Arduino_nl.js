...
// Electron window
Blockly.Msg.com1 = "⚠️ Selecteer USB poort";
Blockly.Msg.com2 = "⚠️ Selecteer USB aub" ;
Blockly.Msg.check = "Controleren...";
Blockly.Msg.upload = "Uploaden...";
Blockly.Msg.error = "🛑 FOUT: Blokken niet verbonden";
Blockly.Msg.verif = "⛔ Controleer de code eerst "
Blockly.Msg.save = "Opslaan als formaat";
Blockly.Msg.update = "Updaten";
Blockly.Msg.new_update = "Een nieuwe versie is beschikbaar, wil je dat nu downloaden en installeren?" ;
Blockly.Msg.yes = "Ja";
Blockly.Msg.no = "Nee";
Blockly.Msg.uptodate = "✅ Versie is actueel!" ;
Blockly.Msg.download = "Download compleet, het programma zal installeren en opnieuw starten ..."
// common to all blocks
Blockly.Msg.HELPURL = "https://ottodiy.com"; // do not translate
Blockly.Msg.pin = "Pin";
Blockly.Msg._AT = "naar";
Blockly.Msg.AV = "vooruit";
Blockly.Msg.AR = "achteruit";
...
// categories (menu)
Blockly.Msg.CAT_TAB = "🔠 Rij";
Blockly.Msg.CAT_list = "🔤 Lijst";
Blockly.Msg.CAT_LOGIC = "🔂 Logische Controle";
Blockly.Msg.CAT_MATH = "🔢 Wiskundige bewerkingen";
...
Blockly.Msg.CAT_ARDUINO_OUT = "↪️ Einde";
...
Blockly.Msg.CAT_APDS9960 = "👋 Gebaar";
...
Blockly.Msg.CAT_BARGRAPH = "💡 LED Strepen";
Blockly.Msg.CAT_LCDI2C = "📟 LCD";
Blockly.Msg.CAT_BUZZER="🎼 Buzzer";
Blockly.Msg.CAT_AUDIO = "🔉 Audio Geluid";
...
Blockly.Msg.CAT_ARDUINO_COMM_SERIAL = "ℹ️ USB Serieel";
Blockly.Msg.CAT_ARDUINO_COMM_SOFTSERIAL = "ℹ️ Software Serieel";
Blockly.Msg.CAT_bluetooth = "🔵 Bluetooth";
Blockly.Msg.CAT_RemoteIR = "🕹️ Afstandbediening";
...
Blockly.Msg.RTCDS3231_RTC="⏲️ Zet Datum & Tijd ";
...
Blockly.Msg.RTCDS3231_READ_RTC="⏲️ RTC Lees Datum & Tijd";
Blockly.Msg.RTCDS3231_VALUES="waarde";
...
//Wireless
Blockly.Msg.esp8266_init_tooltip = "initialisatie van de wifi module and connection with the indicated parameters";
...
Blockly.Msg.esp8266_recept_tooltip = "ontvangst";
...
Blockly.Msg.esp8266_send_html = "stuur HTML pagina";
Blockly.Msg.esp8266_start_tooltip = "";
Blockly.Msg.esp8266_start = "start server";
Blockly.Msg.esp8266_request_tooltip = "";
Blockly.Msg.esp8266_request = "als we in de zoekactie vinden";
Blockly.Msg.esp8266_request_container = "we vinden";
Blockly.Msg.esp8266_html_webpage = "Naam van de HTML pagina:";

//INTERRUPTION
Blockly.Msg.LKL_ATTACHINTERRUPT_PIN = 'Interrupt: als a';
...
Blockly.Msg.on_off = [["AAN", "HIGH"], ["UIT", "LOW"]];
Blockly.Msg.menublink = [["langzaam", "1000"], ["snel", "100"]];
...
Blockly.Msg.FIELDDROPDOWN_ONOFF = [["zet aan", Blockly.Msg.high], ["zet uit", Blockly.Msg.low]];
...
Blockly.Msg.menudht = [["💧luchtvochtigheid", "h"], ["🌡️temperatuur", "t"]];
Blockly.Msg.couleur = [["blauw", "blue"], ["geel", "yellow"], ["rood", "red"], ["groen", "green"]];
Blockly.Msg.sens = [["vooruit", "a"], ["draai rechts", "d"], ["draai links", "g"]];
//sensor
Blockly.Msg.VL53L0X="Laser Pins I²C";
Blockly.Msg.VL53L0X_tooltip="initialize VL53L0X sensor.\nSensor <--> Arduino\nSDA <--------> A4\nSCL <--------> A5";
Blockly.Msg.VL53L0X_distance="afstand (mm)";
Blockly.Msg.VL53L0X_distance_tooltip="VL530X :\ngeef de afstand gemeten door de laser in mm";
Blockly.Msg.bme280="Luchtdruk Pins I²C";
Blockly.Msg.bme280_tooltip="initialize BME280 sensor.\nSensor <--> Arduino\nSDA <--------> A4\nSCL <--------> A5";
Blockly.Msg.bme280_pressure="luchtdruk (hPa)";
Blockly.Msg.bme280_pressure_tooltip="BME280 :\ngeef de luchtdruk in hPa";
Blockly.Msg.inter="schakelaar is";
Blockly.Msg.inter_tooltip="is waar als de schakelaar in de aangegeven positie staat";
Blockly.Msg.mc005="aanwezigheid gedetecteerd op de Pin";
Blockly.Msg.mc005_tooltip="MC005:\nreturns true (false) if a presence is (is not) detected";
Blockly.Msg.bp = "knop gedrukt op Pin";
Blockly.Msg.bp_tooltip = "is waar als de knop is ingedrukt";
Blockly.Msg.dht11_tooltip="DHT11 :\ngeeft de luchtvochtigheid (van 20 tot 80%) of \n de temperatuur (van 2 tot 50�C)";
Blockly.Msg.dht22_tooltip = "DHT22: \ngeeft de luchtvochtigheid (van 0 tot 100%) of \n de temperatuur (van -40 to 80�C)";
Blockly.Msg.suiveur_ligne = "zwarte lijn gedetecteerd op de Pin";
Blockly.Msg.suiveur_ligne_tooltip = "CAP227: \nreturns true (false) if a black line is (is not) detected";
Blockly.Msg.light = "helderheid op pin";
...
Blockly.Msg.light_tooltip = "returns a value depending on the brightness \n0: darkness \n255: full light";
Blockly.Msg.grove_ldr = "helderheid on pin";
...
Blockly.Msg.ultrason_1 = "afstand < limiet";
Blockly.Msg.ultrason_2 = "geeft HOOG terug als de gemeten afstand minder is dan de limiet";
Blockly.Msg.ultrason_distance1 = "afstand (cm)";
Blockly.Msg.ultrason_tooltip = "HC-SR04: \nUltrasone afstandmeter (tussen 3cm en 400cm)\ngeef de pins van de Arduino waarmee verbonden word SCHAKELAAR en ECHO";
Blockly.Msg.ultrason = "Ultrasound Pins";
Blockly.Msg.ultrason_distance2 = "HC-SR04: \ngeeft de gemeten afstand in cm van de ultrasone detector";
Blockly.Msg.pir = "beweging gedetecteerd";
Blockly.Msg.feu = "vlam gedetecteerd";
Blockly.Msg.presence = "obstakel gedetecteerd";
Blockly.Msg.appui = "raak aan ";
...
Blockly.Msg.LCD_SHIELD_PRINT_TEXT = "toon";
...
// structure
Blockly.Msg.loop = "🔄 Lus";
Blockly.Msg.init = "⚙️ Initialisatie";
...
Blockly.Msg.def = "⚙️ Declaratie";
Blockly.Msg.def_tooltip = "alle blokken die hier geplaatst zijn, zullen maar één keer uitgevoerd worden. Dit is waar de verschillende sensoren of actuatoren ingesteld zijn";
Blockly.Msg.END = "🏁 EIND";
Blockly.Msg.END_tooltip = "Stop het programma, blokken hierna worden niet uitgevoerd";
Blockly.Msg.code_tooltip = "Type een instructie die niet uit blokken bestaat";
//matrix
...
Blockly.Msg.millis_start="start een tijdmeting in";
Blockly.Msg.millis_tooltip="";
Blockly.Msg.millis_start_tooltip="";
Blockly.Msg.ARDUINO_INOUT_Pulsein = "geeft de duur in microsecondes van een OP- of NEER-puls toegepast op een pin. Als de parameterwaarde HOOG is, wacht het blok tot de pin HOOG is en dan start de tijdmeting, wacht tot de pin LAAG is en stopt dan de tijdmeting.";
Blockly.Msg.ARDUINO_BASE_DELAY = "⏲ wacht";
Blockly.Msg.ARDUINO_BASE_DELAY_TOOLTIP = "Geef de wachttijd in secondes, millisecondes of microsecondes aan. \nHet programma doet in deze tijd niets anders";
Blockly.Msg.millis1 = "duur in";
Blockly.Msg.millis2 = "vanaf het begin";
Blockly.Msg.ARDUINO_SINCE_PROGRAM_STARTED_TOOLTIP = "geef de duur in millisecondes, secondes of microsecondes sind het programma is gestart";
Blockly.Msg.ARDUINO_PULSEIN = "duur van de toestand";
Blockly.Msg.tempo_helpurl = "https://www.arduino.cc/en/tutorial/blink";// do not translate
Blockly.Msg.tempo_tooltip = "Dit blok controleert of de aangegeven tijd is verstreken, zo ja dan voer de blokken uit .. dit blok wacht niet zoals het blok 'to wait'." ;
Blockly.Msg.tempo1 = "elke";

// LED
Blockly.Msg.ARDUINO_INOUT_BUILDIN_LED_INPUT = "💡 LED op het bord";
Blockly.Msg.ARDUINO_INOUT_BUILDIN_LED_TOOLTIP = "Schakel de LED op het Arduino bord uit of aan";
Blockly.Msg.blink = "💡 LED op het bord knippert";
...
Blockly.Msg.rvb_set="🚥 toon kleur";
Blockly.Msg.rvb_set_tooltip="toont kleur aan de hand van drie componenenten (rood, groen, blauw)";
Blockly.Msg.pixel1 = "NeoPixel";
Blockly.Msg.pixel2 = "🌈 toon pixels";
Blockly.Msg.pixel3 = "kleur";
Blockly.Msg.pixel4 = "aantal pixels";
...
Blockly.Msg.play_tooltip = "speel de noot";
Blockly.Msg.play_helpurl = "";
Blockly.Msg.beep = "🦗 piep op Pin";
Blockly.Msg.beep_TOOLTIP = "piept (met 440Hz voor 1s) op de geselecteerde Pin";
Blockly.Msg.ARDUINO_TONE_INPUT1 = "🎼 Buzzer Pin";
Blockly.Msg.ARDUINO_TONE_INPUT2 = "🎼 frequentie (Hz)";
Blockly.Msg.ARDUINO_TONE_INPUT3 = "⏰ duur (ms)";
...
Blockly.Msg.ARDUINO_RTTTL_BLOCK = "Speel Ring Tone";
...
Blockly.Msg.ARDUINO_SERVO_MOVE_TOOLTIP = "mogelijke draaiing tussen 0 en 180 graden";
Blockly.Msg.ARDUINO_SERVO_ROT_CONTINUE_TEXT = "Draai wiel";
Blockly.Msg.ARDUINO_SERVO_ROT_CONTINUE_TOOLTIP = "Draai het servo wiel verbonden met de aangegeven pin, met de aangegeven snelheid [0-90] en in de gekozen richting";
//engine
...
Blockly.Msg.moteur = "Draai motor DC";
...
Blockly.Msg.ADAFRUIT_MOTORSHIELD_MOTOR_DIRECTION = "richting";
Blockly.Msg.ADAFRUIT_MOTORSHIELD_MOTOR_VITESSE = Blockly.Msg.vitesse+"[0-255]";
Blockly.Msg.ADAFRUIT_MOTORSHIELD_AVANT = "vooruit";
Blockly.Msg.ADAFRUIT_MOTORSHIELD_ARRIERE = "achteruit";
...
Blockly.Msg.m_pap_step1="beweeg vooruit";
...
Blockly.Msg.OTTO9_HOME_TEXT = "Begin";
Blockly.Msg.OTTO9_HOME_TOOLTIP = "Otto gaat rechtstreeks naar de beginpositie";
...
Blockly.Msg.OTTO9_CALIBRATION='Afstellen ';
...
Blockly.Msg.OTTO9_MOVE_TEXT = "Beweeg";
Blockly.Msg.OTTO9_MOVE_TOOLTIP = "Otto basisbewegingen";
Blockly.Msg.OTTO9_MOVE_CHOICE = [["↑ vooruit", "FORWARD"], ["↓ achteruit", "BACKWARD"], ["↺ draai links", "LEFT"], ["↻ draai rechts", "RIGHT"], ["buig naar links", "BENDLEFT"], ["buig naar rechts", "BENDRIGHT"], ["schud linkerbeen", "SHAKELEFT"], ["schud rechterbeen", "SHAKERIGHT"], ["op", "spring"]];
Blockly.Msg.OTTO9_MOVEW_CHOICE = [["↑ vooruit", "FORWARD"], ["↓ achteruit", "BACKWARD"], ["↺ draai links", "LEFT"], ["↻ draai rechts", "RIGHT"]]; 
...
Blockly.Msg.OTTO9_DANCE_TOOLTIP = "Otto dans!";
...
Blockly.Msg.OTTO9_DO_TEXT = "Doe";
Blockly.Msg.OTTO9_DO_TOOLTIP = "Otto ingewikkelde bewegingen";
Blockly.Msg.OTTO9_DO_CHOICE = [ ["swing", "swing"], ["opneer", "updown"], ["tiptoeSwing", "tiptoeSwing"], ["jitter", "jitter"], ["ascendingTurn", "ascendingTurn"]];
Blockly.Msg.OTTO9_GESTURE_TEXT = "Gebaar";
Blockly.Msg.OTTO9_GESTURE_TOOLTIP = "Emotionele geluiden met bewegingen";
Blockly.Msg.OTTO9_GESTURE_CHOICE = [["😃 blij1", "OttoSuperHappy"],["🙂 blij2", "OttoHappy"], ["🙁 droevig", "OttoSad"], ["😴 slaap", "OttoSleeping"], ["😕 verward", "OttoConfused"], ["😰 fretful", "OttoFretful"], ["😍 liefde", "OttoLove"], ["😡 boos", "OttoAngry"], ["🤩 magisch", "OttoMagic"], ["😐 golf", "OttoWave"], [" 😎 overwinning", "OttoVictory"], ["😞 fail", "OttoFail"], ["💩 scheet", "OttoFart"]];
Blockly.Msg.OTTO9_SOUND_TEXT = "Geluid";
Blockly.Msg.OTTO9_SOUND_TOOLTIP = "Emotionele geluiden";
Blockly.Msg.OTTO9_SOUND_CHOICE = [ ["😃 blij1", "S_superHappy"], ["🙂 blij2", "S_happy"], ["😊 blij3", "S_happy_short"], ["🙁 droevig", "S_sad"], ["😕 verward", "S_confused"], ["🤗 knuffelig", "S_cuddly"], ["😮 Oh", "S_OhOoh"], ["😯 OhOoh", "S_OhOoh2"], ["😲 verrassing", "S_surprise"],["🤖 aanwezig", "S_connection"], [" 🤖 afwezig", "S_disconnection"], ["👇 druk", "S_buttonPushed"], ["❗ 1", "S_mode1"], ["❗❗ 2", "S_mode2"], ["❗❗❗ 3", "S_mode3"], ["💤 slaap", "S_sleeping"], ["💩 scheet1", "S_fart1"], ["💩 scheet2", "S_fart2"], ["💩 scheet3", "S_fart3"],];
Blockly.Msg.OTTO9_GETDISTANCE_TEXT = "Afstand [cm]";
Blockly.Msg.OTTO9_GETDISTANCE_TOOLTIP = "Pin Schakelaar 8 Pin Echo 9. Meetafstand tussen 2cm tot 400cm";
Blockly.Msg.OTTO9_GETOBSTACLE_TEXT = "Obstakel";
Blockly.Msg.OTTO9_OBSTACLE_CHOICE = [["dichtbij", "10"],["heel dichtbij", "3"],["ver", "30"]];
Blockly.Msg.OTTO9_GETNOISE_TEXT = "Gemeten ruis";
Blockly.Msg.OTTO9_GETNOISE_TOOLTIP = "Pin A6, 100 is stil, 500 ruis en meer dan 1000 is hard, pas ook de gevoeligheid van de sensor trimpot aan";
Blockly.Msg.OTTO9_GETG_TEXT = "Lees versnelling & draaisnelheid";
Blockly.Msg.OTTO9_GETG_TEXT2 = "Waarde";
Blockly.Msg.OTTO9_MOUTH_TEXT = "Mond";
Blockly.Msg.OTTO9_MOUTH_TOOLTIP = "Mondemotie voor de 8x8 LED matrix #0-30";
Blockly.Msg.OTTO9_MOUTH_CHOICE = [["😃 blij1", "happyOpen"],["🙂 blij2", "happyClosed"], ["😊 lach", "smile"], ["😦 droevig1", "23"], ["🙁 droevig2", "24"], ["😮 verrast", "smallSurprise"], ["😲 verrast2", "bigSurprise"], ["😕 verward", "confused"],["😛 tong", "tongueOut"],["🙃 gek", "culito"],  ["😑 serieus", "lineMouth"], ["🙄 boos", "21"], ["💖 hart", "heart"], ["🦇 vleermuis1", "vamp1"], ["🦇 vleermuis2", "vamp2"], ["❌ nee", "xMouth"], ["✅ OK", "okMouth"],["❓?", "27"], ["⚡ donder", "thunder"]];
Blockly.Msg.OTTO9_MATRIX_TOOLTIP = "Pins: DIN A3, CS A2, CLK A1, Begrensd tot HOOFDLETTERS A tot Z CIJFERS 0 tot 9 : ; < >  = @, max.9 karakters";
Blockly.Msg.OTTO9_MATRIXTEXT_TEXT = "👄 Mondtekst";
Blockly.Msg.OTTO9_EYES_TEXT = "Ogen";
Blockly.Msg.OTTO9_EYES_TOOLTIP = "Pins I²C, Oogemotie voor de 16x8 I²C LED matrix ";
Blockly.Msg.OTTO9_EYES_CHOICE = [["😃 blij1", "happy_bmp"],["🙂 blij2", "eyes_bmp"], ["😦 droevig", "sad_bmp"], ["😡 boos1", "angry_bmp"], ["😡 boos2", "angry2_bmp"], ["😰 bang", "freetful_bmp"], ["😕 verward", "confused_bmp"],["😴 slaap", "sleep_bmp"],["😍 liefde", "love_bmp"],  ["😑 golf", "wave_bmp"], ["🤩 magisch", "magic_bmp"], ["😞 mislukt", "fail_bmp"], ["🤖 logo", "logo_bmp"], ["❌❌ nee", "XX_bmp"], ["x x", "xx_bmp"],["▉", "full_bmp"]];
Blockly.Msg.OTTO9_EYESTEXT_TEXT = "👀 Oogtekst";
Blockly.Msg.OTTO9_EYES_CLEAR_TEXT = "👀 schoon🧹";
Blockly.Msg.OTTO9_CLEAR_TEXT = "👄 schoon🧹";
Blockly.Msg.OTTO9_CLEAR_TOOLTIP = "Zet alle LEDs van de mondmatrix 8x8 uit";
Blockly.Msg.OTTO9_ARMS_TEXT = "Arm ";
Blockly.Msg.OTTO9_ARMS_TOOLTIP = "Beweeg de armen!";
Blockly.Msg.OTTO9_ARMS_CHOICE = [["handen omhoog", "HANDSUP"],["handen omhoog", "HANDSDOWN"], ["handwuif links", "HANDWAVE1"], ["handwuif rechts", "HANDWAVE2"]];

////////////ESCORNABOT Robot////////// ONLY TRANSLATE THE LEFT PART INSIDE ["THIS YES" ,NOT]
Blockly.Msg.ESCORNABOT_MODE_TEXT="Escornabot";
Blockly.Msg.ESCORNABOT_MODE_CHOICE= [["Zwak", ""], ["Sterk", "(2)"], ["Middel", "(3)"]];;
...
Blockly.Msg.ESCORNABOT_SPIN_VELOCITY=[["Langzaam", "5"], ["Middel", "10"], ["Snel", "15"]];;
Blockly.Msg.ESCORNABOT_DISTANCE="Ren afstand: ";
...
//SIMPLE SENSORS
Blockly.Msg.BUTTON_NAME="Knop";
Blockly.Msg.INTERNAL_BUTTON_NAME="Start knop MRTduino bord";
Blockly.Msg.BUTTON_LOGIC="Logic inverse";
Blockly.Msg.BUTTON_PRESSED="Ingedrukt";
Blockly.Msg.BUTTON_TOUCH_NAME="Raak aan";
Blockly.Msg.KNOCK_NAME="Sla";
Blockly.Msg.KNOCK_DETECTED="gedetecteerd";
Blockly.Msg.TILT_NAME="Digital Tilt";
Blockly.Msg.TILT_DETECTED="gedetecteerd";
...
Blockly.Msg.PHOTO_DETECTED="gedetecteerd";
Blockly.Msg.VAR_LM35="Temperatuur LM35 (ºC)";
Blockly.Msg.LDR_NAME="Fotocel";
Blockly.Msg.LDR_DETECTED="gedetecteerd";
Blockly.Msg.IR_NAME="Infrarood";
Blockly.Msg.IR_DETECTED="gevoeld";
Blockly.Msg.FLAME_NAME="Vlam";
Blockly.Msg.FLAME_DETECTED="gedetecteerd";
Blockly.Msg.SOUND_NAME="Geluid (MIC)";
Blockly.Msg.SOUND_AMP_NAME="MIC Versterker";
Blockly.Msg.SOUND_WINDOWS="Opnametijd";
Blockly.Msg.SOUND_DETECTED="gedetecteerd";
...
Blockly.Msg.DHT_Temp="🌡️ Temperatuur ºC";
Blockly.Msg.DHT_Humi="💧 Luchtvochtigheid %";
Blockly.Msg.DHT_Head="☀️ Warmte Index ºC";
Blockly.Msg.GAS_NAME="Gas CO";
Blockly.Msg.GAS_DETECTED="gedetecteerd";
Blockly.Msg.ALCOHOL_NAME="Alcohol";
Blockly.Msg.AIR_NAME="Luchtkwaliteit (MQ-135)";
Blockly.Msg.ALCOHOL_DETECTED="gedetecteerd";
Blockly.Msg.VIBRATION_NAME="Vibratie";
Blockly.Msg.VIBRATION_DETECTED="gedetecteerd";
Blockly.Msg.HALL_NAME="Hall Magnetisch";
Blockly.Msg.HALL_DETECTED="gedetecteerd";
Blockly.Msg.PIR_NAME="PIR Motion";
Blockly.Msg.PIR_DETECTED="gedetecteerd";
Blockly.Msg.VAPOR_NAME="Damp";
Blockly.Msg.ALIGHT_NAME="Omgevingslicht";
Blockly.Msg.WATER_NAME="Waterniveau";
Blockly.Msg.MOISTURE_NAME="Bodemvocht";
Blockly.Msg.JOYSTICK_NAME="Joystick as";
Blockly.Msg.JOYSTICK_BUTTON="Joystick knop";
Blockly.Msg.JOYSTICK_PRESSED="ingedrukt";
Blockly.Msg.ultrasonic_ranger="Ultrasound Pins";
Blockly.Msg.unit="Eenheid";
Blockly.Msg.cm="cm";
...
Blockly.Msg.CCS811_available="sensor beschikbaar?";
Blockly.Msg.CCS811_readed = "meting uitgelezen?";
Blockly.Msg.CCS811_values="waarde";

//LCD I2C
Blockly.Msg.LCD_I2C_setup = "LCD I²C Address";
Blockly.Msg.LCDP_Column = "Kolommen";
Blockly.Msg.LCDP_Row = "Rijen";
Blockly.Msg.LCDP_Column2 = "kolom";
Blockly.Msg.LCDP_Row2 = "rij";
Blockly.Msg.LCDP_Print = "Druk af";
Blockly.Msg.LCDP_Clear = "LCD I²C schoon";
Blockly.Msg.LCDP_scrollDisplay = "LCD I²C rol scherm ";
Blockly.Msg.LCDP_setBcklight = "LCD I²C zet achtergrondlicht ";
Blockly.Msg.LCDP_showCursor = "LCD I²C laat cursor zien ";
Blockly.Msg.LCDP_blinkCursor = "LCD I²C knipper cursor ";
Blockly.Msg.LCDP_Home = "LCD I²C Thuis";
Blockly.Msg.LCDP_SetCursor = "LCD I²C zet cursor";
Blockly.Msg.LCDP_Display = "LCD I²C ";

//GESTURE SENSOR APDS9960
Blockly.Msg.APDS9960_name_gesture = "👋 Gebaar";
Blockly.Msg.APDS9960_name_color = "Kleur";
Blockly.Msg.APDS9960_detection = "detectie";
Blockly.Msg.APDS9960_init = "Gebaar- & Kleurenpins";
Blockly.Msg.APDS9960_init2 = "I²C";
Blockly.Msg.APDS9960_gesture_gain = "Config gebaar gain";
Blockly.Msg.APDS9960_color_gain = "Config kleur gain";
Blockly.Msg.APDS9960_gesture_detected = "gedetecteerd";
Blockly.Msg.APDS9960_readgesture = "Lees";
Blockly.Msg.APDS9960_readcolors = "Lees kleurfrequenties";
Blockly.Msg.APDS9960_colors = "Frequentie";

//REMOTE CONTROL IR
Blockly.Msg.KEY="Key";
Blockly.Msg.GENERAL_IR="Afstandbediening IR";
Blockly.Msg.GENERAL_PRESSED="Lees toets";
Blockly.Msg.PIN="Pin";

//REMOTE CONTROL MRT
Blockly.Msg.MRT_IR="Afstandbediening MRT";
Blockly.Msg.MRT_CHANNEL="Kanaal";
Blockly.Msg.MRT_KEY="Toets MRT";
Blockly.Msg.MRT_PRESSED="Ingedrukt?";
...
/*模块文本*/
Blockly.LKL_VS2_MU = 'initialiseer';									//'初始化';
...
Blockly.LKL_VS2_SERIAL = 'poort';									//'端口';
Blockly.LKL_VS2_ADDRESS = 'adres';								//'地址';
Blockly.LKL_VS2_RESET = 'reset to default';						    //'恢复默认设置';
Blockly.LKL_VS2_LED_DETECT_COLOR = 'when detected then';			//'识别到物体亮';
Blockly.LKL_VS2_LED_UNDETECT_COLOR = 'anders';				        //'没识别到物体亮';
Blockly.LKL_VS2_BRIGHTNESS = 'helderheid';							//'亮度';
Blockly.LKL_VS2_VISION_TYPE = 'algoritme';						    //'算法';
Blockly.LKL_VS2_SET_VISION_LEVEL = 'niveau';				            //'设置识别等级';
...
Blockly.Msg.ST7735_Rotate = "draai";
...
Blockly.Msg.ST7735_TEXTCOLOR = "Zet tekstkleur";
Blockly.Msg.ST7735_TEXTCOLOR2 = "kleur";
Blockly.Msg.ST7735_TEXTsize = "Zet tekstgrootte";
Blockly.Msg.ST7735_TEXTwrap = "Set text wrap";
Blockly.Msg.ST7735_PrintTextLN = "Print the text/value";
Blockly.Msg.ST7735_PrintTextLN2 = "volgende regel";
Blockly.Msg.ST7735_DrawPixel = "Teken pixel";
Blockly.Msg.ST7735_Drawlinefrom = "Teken lijn van";
Blockly.Msg.ST7735_Drawlineto = "naar";
Blockly.Msg.ST7735_Drawrectangle = "Teken rechthoek";
Blockly.Msg.ST7735_Drawtriangle = "Teken driehoek.Hoekpunten";
Blockly.Msg.ST7735_Drawroundrectangle = "Draw round rectangle";
Blockly.Msg.ST7735_Drawroundrectangleradius = "round";
Blockly.Msg.ST7735_Drawrectanglewidth = "breedte";
Blockly.Msg.ST7735_Drawrectangleheight = "hoogte";
Blockly.Msg.ST7735_Drawcircle = "Draw circle.Center in";
Blockly.Msg.ST7735_Drawcircleradius = "radius";
Blockly.Msg.ST7735_Drawfill = "Vul";
...
Blockly.Msg.OLED_height = "hoofte";
Blockly.Msg.OLED_COLOR = "Zet kleur";
...
Blockly.Msg.MOTOR_Direction="Richting";
Blockly.Msg.MOTOR_speed="Snelheid (0-255)";
...
Blockly.Msg.MAX7219_LM_Brightness="helderheid";
Blockly.Msg.MAX7219_LM_SHUTDOWN="Activate";
Blockly.Msg.MAX7219_LM_CLEAR="Schoon";
Blockly.Msg.MAX7219_LM_PAINT="Teken dit beeld";
Blockly.Msg.MAX7219_LM_Row="Rij";
Blockly.Msg.MAX7219_LM_value="Waarde (bin or hex or dec)";
Blockly.Msg.MAX7219_LM_Column="Kolom";
...
Blockly.Msg.TEXT_APPEND_APPENDTEXT = "voeg tekst toe";
Blockly.Msg.TEXT_APPEND_HELPURL = "https://github.com/google/blockly/wiki/Text#text-modification";
Blockly.Msg.TEXT_APPEND_TO = "naar";
Blockly.Msg.TEXT_APPEND_TOOLTIP = "Voeg tekst toe aan variabele '%1'.";
Blockly.Msg.TEXT_CHANGECASE_HELPURL = "https://github.com/google/blockly/wiki/Text#adjusting-text-case";
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_LOWERCASE = "naar kleine letters";
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_TITLECASE = "naar Eerste Hoofdletters";
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_UPPERCASE = "naar HOOFDLETTERS";
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP = "Geef een kopie van de tekst met kleine-, hoofd- of eerste hoofdletters.";
Blockly.Msg.TEXT_CHARAT_FIRST = "neem de eerste letter";
Blockly.Msg.TEXT_CHARAT_FROM_END = "neem letter # van het eind";
Blockly.Msg.TEXT_CHARAT_FROM_START = "neem letter #";
Blockly.Msg.TEXT_CHARAT_HELPURL = "https://github.com/google/blockly/wiki/Text#extracting-text";
Blockly.Msg.TEXT_CHARAT_INPUT_INTEXT = "in tekst";
Blockly.Msg.TEXT_CHARAT_LAST = "neem de laatste letter";
Blockly.Msg.TEXT_CHARAT_RANDOM = "neem een willekeurige letter";
Blockly.Msg.TEXT_CHARAT_TAIL = "";
Blockly.Msg.TEXT_CHARAT_TOOLTIP = "Geef de letter op de aangegeven positie.";
Blockly.Msg.TEXT_CREATE_JOIN_ITEM_TOOLTIP = "Voeg een onderdeel toe aan de tekst.";
Blockly.Msg.TEXT_CREATE_JOIN_TITLE_JOIN = "samenvoegen";
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP = "Add, remove, or reorder sections to reconfigure this text block.";
Blockly.Msg.TEXT_GET_SUBSTRING_END_FROM_END = "naar letter # van het eind";
Blockly.Msg.TEXT_GET_SUBSTRING_END_FROM_START = "naar letter #";
Blockly.Msg.TEXT_GET_SUBSTRING_END_LAST = "naar de laatste letter";
