...
// Electron window
Blockly.Msg.com1 = "⚠️ Избери USB порт";
Blockly.Msg.com2 = "⚠️ Избери USB моля" ;
Blockly.Msg.check = "Проверява...";
Blockly.Msg.upload = "Качва...";
Blockly.Msg.error = "🛑 Грешка: Блоковете не са свързани";
Blockly.Msg.verif = "⛔ Провери първо кода "
Blockly.Msg.save = "Запомни във формат";
Blockly.Msg.update = "Обнови";
Blockly.Msg.new_update = "Налична е нова версия, желате ли да я свалите и инсталирате сега?" ;
Blockly.Msg.yes = "Да";
Blockly.Msg.no = "Не";
Blockly.Msg.uptodate = "✅ Версията е актуална!" ;
Blockly.Msg.download = "Свалянето приключи, приложението ще се инсталира и рестартира..."
// common to all blocks
Blockly.Msg.HELPURL = "https://ottodiy.com"; // do not translate
Blockly.Msg.pin = "Pin";
Blockly.Msg._AT = "at";
Blockly.Msg.AV = "напред";
Blockly.Msg.AR = "назад";
Blockly.Msg.high = "HIGH"; // do not translate
Blockly.Msg.low = "LOW"; // do not translate
Blockly.Msg.right = "дясно";
Blockly.Msg.left = "ляво";
Blockly.Msg.LetR = "дясно & ляво";
Blockly.Msg.direction = "посока";
Blockly.Msg.vitesse = "скорост";
Blockly.Msg.values = "↺0-90 | ↻90-180";
Blockly.Msg.Name = "Име";
// categories (menu)
Blockly.Msg.CAT_TAB = "🔠 Масив";
Blockly.Msg.CAT_list = "🔤 Лист";
Blockly.Msg.CAT_LOGIC = "🔂 Логически операции";
Blockly.Msg.CAT_MATH = "🔢 Математически операции";
Blockly.Msg.CAT_TEXT = "🔤 Текст";
Blockly.Msg.CAT_VARIABLES = "🔀 Променливи";
Blockly.Msg.CAT_FUNCTIONS = "🔣 Функции";
Blockly.Msg.CAT_ARDUINO = "🔄 Структури";
Blockly.Msg.CAT_ARDUINO_IN = "🔛 Вход / Изход";
Blockly.Msg.CAT_ARDUINO_OUT = "↪️ Изход";
Blockly.Msg.CAT_ARDUINO_TIME = "⏱️ Time";
Blockly.Msg.CAT_OTTO = "🤖 Otto";
Blockly.Msg.CAT_OTTO_DIY = "🤖 Otto DIY";
Blockly.Msg.CAT_ARDUINO_matrice8x8 = "👄 LED Уста";
Blockly.Msg.CAT_ARDUINO_matrice16x8 = "👀 LED Очи";
Blockly.Msg.CAT_ESCORNABOT="🐞 Escornabot";
Blockly.Msg.CAT_servo = "🦾 Серво";
Blockly.Msg.CAT_servo360 = "💿 Серво 360°";
Blockly.Msg.CAT_actionneur = "⚙️ Мотор";
Blockly.Msg.CAT_ARDUINO_moteur="⚙️ Стъпков мотор";
Blockly.Msg.CAT_ultrason = "👂 Сензори";
Blockly.Msg.CAT_SENSORS = "👂 Усещания";
Blockly.Msg.CAT_numerique = "0️⃣ Дигитално";
Blockly.Msg.CAT_analogique = "🔢 Аналогово";
Blockly.Msg.CAT_GYRO = "⚖️ Жироскоп";
Blockly.Msg.CAT_VIBRATE = "🖐️ Вибрация";
...
Blockly.Msg.CAT_HMC5883="🧭 Компас";
Blockly.Msg.CAT_RFID="💳 RFID";
Blockly.Msg.CAT_KEYBOARD="🖱️Мишка & ⌨️Клавиатура";
...
Blockly.Msg.CAT_BME280 = "🗜️ Налягане";
Blockly.Msg.CAT_VL53L0X = "📏 Разстояние";
Blockly.Msg.CAT_APDS9960 = "👋 Жестове";
Blockly.Msg.CAT_TCS34725 = "🌈 Цвят";
Blockly.Msg.CAT_Displays = "💻 Екрани";
Blockly.Msg.CAT_OLED_U8G = "🖥️ OLED";
Blockly.Msg.CAT_TFT_ST7735 = "📺 TFT";
Blockly.Msg.CAT_del = "💡 LED Single";
...
Blockly.Msg.CAT_MAX7219 = "💡 Матрица 8x8";
Blockly.Msg.CAT_MAX1640 = "💡 Матрица 16x8";
Blockly.Msg.CAT_BARGRAPH = "💡 LED Bars";
Blockly.Msg.CAT_LCDI2C = "📟 LCD";
Blockly.Msg.CAT_BUZZER="🎼 Buzzer";
Blockly.Msg.CAT_AUDIO = "🔉 Аудио Звук";
Blockly.Msg.CAT_DFPLAYER = "🔊 MP3 DFMini";
Blockly.Msg.CAT_OPENSMART = "🔊 MP3 OpenSmart";
Blockly.Msg.CAT_RADIO_TEA5767="📻 Радио";
Blockly.Msg.CAT_CAMERAS = "📷 Камери";
Blockly.Msg.CAT_MUVISION = "👁️ MuVision";
Blockly.Msg.CAT_com = "📡 Комуникация";
Blockly.Msg.CAT_ARDUINO_COMM_SERIAL = "ℹ️ USB Сериен";
Blockly.Msg.CAT_ARDUINO_COMM_SOFTSERIAL = "ℹ️ Софтуерен сериен";
Blockly.Msg.CAT_bluetooth = "🔵 Bluetooth";
Blockly.Msg.CAT_RemoteIR = "🕹️ Дистанционно";
...
Blockly.Msg.RTCDS3231_RTC="⏲️ Настрой Дата и Час";
Blockly.Msg.RTCDS3231_DAY="Ден";
Blockly.Msg.RTCDS3231_MONTH="Месец";
Blockly.Msg.RTCDS3231_YEAR="Година";
Blockly.Msg.RTCDS3231_HOUR="Час";
Blockly.Msg.RTCDS3231_MINUTE="Минута";
Blockly.Msg.RTCDS3231_SECOND="Секунда";
Blockly.Msg.RTCDS3231_DOFWEEK="Ден от седмицата";
Blockly.Msg.RTCDS3231_READ_RTC="⏲️ RTC Прочети Дата и Час";
Blockly.Msg.RTCDS3231_VALUES="стойност";
Blockly.Msg.RTCDS3231_Name2="⏲️ RTC.";
Blockly.Msg.RTCDS3231_TEXT_DOFWEEK="Ден от седмицата като текст ";
Blockly.Msg.RTCDS3231_TEXT_MONTH="Месец като текст ";
...
Blockly.Msg.times = [["секунди", "s"], ["милисекунди", "m"], ["микросекунди", "u"]];
Blockly.Msg.time = [["секунди", "s"], ["милисекунди", "m"]];
...
Blockly.Msg.FIELDDROPDOWN_ONOFF = [["включи", Blockly.Msg.high], ["изключи", Blockly.Msg.low]];
...
Blockly.Msg.menudht = [["💧влажност", "h"], ["🌡️температура", "t"]];
Blockly.Msg.couleur = [["синьо", "blue"], ["жълто", "yellow"], ["червено", "red"], ["зелено", "green"]];
Blockly.Msg.sens = [["наоред", "a"], ["обърни се надясно", "d"], ["обърни се наляво", "g"]];
//sensor
...
// structure
Blockly.Msg.loop = "🔄 Цикъл";
Blockly.Msg.init = "⚙️ Настройка";
Blockly.Msg.base_setup_loop = "Инициализираща функция: \nИзползва се за инициализация на променливи, посока на пиновете ... \nИзпълнява се само веднъж \nЦиклична функция: \nТова е главната част от програмата, всички блокове в тази част ще се изпълняват в безкраен цикъл (няколко хиляди пъти в секунда) ";
Blockly.Msg.loop_tooltip = "всички блокове поставени тук ще се изпълняват в безкраен цикъл (няколко хиляди пъти в секунда)";
Blockly.Msg.begin_tooltip = "този блок се използва, за да дефинира реда, по който програмата трябва се изпълнява";
Blockly.Msg.begin = "🏁 НАЧАЛО";
Blockly.Msg.def = "⚙️ Декларации";
Blockly.Msg.def_tooltip = "всички блокове сложени тук ще се изпълнят само веднъж, тук е мястото където различни сензори и задвижващи механизми се конфигурират";
Blockly.Msg.END = "🏁 КРАЙ";
Blockly.Msg.END_tooltip = "Край на програмата, блоковете сложени след този ще бъдат игнорирани";
Blockly.Msg.code_tooltip = "Въведи инструкции, които не са в блокове";
//matrix
...
Blockly.Msg.OTTO9_HOME_TEXT = "Начало";
Blockly.Msg.OTTO9_HOME_TOOLTIP = "Otto отива направо в начална позиция";
Blockly.Msg.OTTO9_BUZZER="🎼 Buzzer";
Blockly.Msg.OTTO_HOME_TEXT = "Пинове";
Blockly.Msg.OTTO9_DIY_URL = "https://www.ottodiy.com/academy";// do not translate
Blockly.Msg.OTTO9_CALIBRATION='Калибрирай ';
Blockly.Msg.OTTO9_CALIBRATION_LEG='Крак ';
Blockly.Msg.OTTO9_CALIBRATION_FOOT='Стъпало ';
...
Blockly.Msg.OTTO9_MOVE_TEXT = "Движение";
Blockly.Msg.OTTO9_MOVE_TOOLTIP = "Otto основни движения";
Blockly.Msg.OTTO9_MOVE_CHOICE = [["↑ напред", "FORWARD"], ["↓ назад", "BACKWARD"], ["↺ завърти наляво", "LEFT"], ["↻ завърти надясно", "RIGHT"], ["наклони се наляво", "BENDLEFT"], ["наклони се надясно", "BENDRIGHT"], ["разклати ляв крак", "SHAKELEFT"], ["разклати десен крак", "SHAKERIGHT"], ["нагоре", "jump"]];
Blockly.Msg.OTTO9_MOVEW_CHOICE = [["↑ напред", "FORWARD"], ["↓ назад", "BACKWARD"], ["↺ завърти наляво", "LEFT"], ["↻ завърти надясно", "RIGHT"]];
Blockly.Msg.OTTO9_MOVE_SPEED_TEXT = "Скорост";
Blockly.Msg.OTTO9_MOVE_SPEED_CHOICE = [["нормално", "1000"],["бавно", "2000"],["много бавно", "3000"] , ["бързо", "750"], ["много бързо", "500"], ["супер бързо", "250"]];
Blockly.Msg.OTTO9_MOVEW_SPEED_CHOICE = [["нормално", "45"],["бавно", "20"],["много бавно", "10"] , ["бързо", "60"], ["много бързо", "90"]];
Blockly.Msg.OTTO9_DANCE_TEXT = "Танцувай";
Blockly.Msg.OTTO9_DANCE_TOOLTIP = "Otto dance!";
Blockly.Msg.OTTO9_DANCE_CHOICE = [["лунна походка ⟵", "moonwalkerLEFT"],  ["лунна походка ⟶", "moonwalkerRIGHT"],["crossing ⟵", "crusaitoLEFT"],["crossing ⟶", "crusaitoRIGHT"], ["flapping ↑", "flappingFRONT"], ["flapping ↓", "flappingBACK"]];
Blockly.Msg.OTTO9_DANCE_SIZE_TEXT = "Size";
Blockly.Msg.OTTO9_DANCE_SIZE_CHOICE = [["Нормално", "25"], ["Малък", "10"], ["Голям", "40"]];
Blockly.Msg.OTTO9_DO_TEXT = "Наорави";
...
Blockly.Msg.OTTO9_GESTURE_TEXT = "Мимика";
Blockly.Msg.OTTO9_GESTURE_TOOLTIP = "Емоционален звук в комбинация с движение";
Blockly.Msg.OTTO9_GESTURE_CHOICE = [["😃 happy1", "OttoSuperHappy"],["🙂 happy2", "OttoHappy"], ["🙁 тъжен", "OttoSad"], ["😴 заспал", "OttoSleeping"], ["😕 объркан", "OttoConfused"], ["😰 раздразнен", "OttoFretful"], ["😍 обичащ", "OttoLove"], ["😡 ядосан", "OttoAngry"], ["🤩 магичен", "OttoMagic"], ["😐 ръкомахане", "OttoWave"], [" 😎 победа", "OttoVictory"], ["😞 провал", "OttoFail"], ["💩 пърдене", "OttoFart"]];
Blockly.Msg.OTTO9_SOUND_TEXT = "Звук";
Blockly.Msg.OTTO9_SOUND_TOOLTIP = "Емоционални звуци";
...
Blockly.Msg.OTTO9_GETDISTANCE_TEXT = "Разстояние [cm]";
...
Blockly.Msg.OTTO9_OBSTACLE_CHOICE = [["близко", "10"],["много близко", "3"],["далече", "30"]];
...
//LED color type
Blockly.LKL_VS2_LED_CLOSE = 'Затвори';					//'关闭';
Blockly.LKL_VS2_LED_RED = 'Червен';						//'红色';
Blockly.LKL_VS2_LED_GREEN = 'Зелен';					//'绿色';
Blockly.LKL_VS2_LED_YELLOW = 'Жълто';					//'黄色';
Blockly.LKL_VS2_LED_BLUE = 'Синьо';						//'蓝色';
Blockly.LKL_VS2_LED_PURPLE = 'Лилаво';					//'紫色';
Blockly.LKL_VS2_LED_CYAN = 'Циан';						//'青色';
Blockly.LKL_VS2_LED_WHITE = 'Бяло';					//'白色';
//Vision Zoom
...
//UART status
Blockly.LKL_VS2_UART_OPEN = 'Отвори';						//'打开';
Blockly.LKL_VS2_UART_CLOSE = 'Затвори';					//'关闭';
//Vision type
...
Blockly.LKL_VS2_VISION_BALL = 'Топка';					//'球';
Blockly.LKL_VS2_VISION_LINE = 'Линия';					//'线条';
Blockly.LKL_VS2_VISION_BODY = 'Тяло';					//'人体';
Blockly.LKL_VS2_VISION_FACE = 'Лице';					//'人脸';
...
//Card type
Blockly.LKL_VS2_CARD_CIRCLE = 'Кръг';					//'圆形';
Blockly.LKL_VS2_CARD_TRIANGLE = 'Триъгълник';				//'三角形';
Blockly.LKL_VS2_CARD_SQUARE = 'Квадрат';					//'方形';
Blockly.LKL_VS2_CARD_TICK = 'Отметка';						//'钩';
Blockly.LKL_VS2_CARD_CROSS = 'Кръст';					//'叉';
Blockly.LKL_VS2_CARD_STRAIGHT = 'Направо';				//'向前';
...
Blockly.LKL_VS2_CARD_WHISTLE = 'Свирни';				//'鸣笛';
Blockly.LKL_VS2_CARD_STOP = 'Стоп';						//'停止';
//Vision state
Blockly.LKL_VS2_STATE_VALUE_X = 'Хоризонтално';			//'横向坐标';
Blockly.LKL_VS2_STATE_VALUE_Y = 'Вертикално';				//'纵向坐标';
Blockly.LKL_VS2_STATE_VALUE_WIDTH = 'Широчина';			//'宽度';
Blockly.LKL_VS2_STATE_VALUE_HEIGHT = 'Височина';			//'高度';
...
Blockly.LKL_VS2_STATE_VALUE_LABEL = 'Етикет';			//'标签';
//True False
Blockly.LKL_VS2_TRUE = 'Вярно';							//'是';
Blockly.LKL_VS2_FALSE = 'Грешно';						//'否';
//Enable Disable
Blockly.LKL_VS2_ENABLE = 'активирай';						//'开启';
Blockly.LKL_VS2_DISABLE = 'деактивирай';					//'关闭';
//Camera AWB
...
//Other
Blockly.LKL_VS2_COLOR = 'цвят';						//'颜色';
Blockly.LKL_VS2_DEFAULT = 'по подразбиране';                    //'默认';
...
Blockly.Msg.KeyPressed = "Клавиш";
Blockly.Msg.WriteText= "Напиши текст";
...
Blockly.Msg.STEEPER_Move="Движение";
...
Blockly.Msg.TEXT_INDEXOF_INPUT_INTEXT = "в текст";
...
Blockly.Msg.TEXT_TRIM = "премахни интервалите от ";
