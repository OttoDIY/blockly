...
#define PAC_STATUSA_RESETVALUE      _U(0x00001000); /**< \brief (PAC_STATUSA reset_value) Peripheral write protection status - Bridge A */
...
#define PAC_STATUSB_RESETVALUE      _U(0x00000022); /**< \brief (PAC_STATUSB reset_value) Peripheral write protection status - Bridge B */
