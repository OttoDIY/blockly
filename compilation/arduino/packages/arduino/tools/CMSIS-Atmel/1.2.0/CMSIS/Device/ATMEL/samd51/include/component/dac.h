...
#define DAC_CTRLA_RESETVALUE        _Ul(0x00)     /**< \brief (DAC_CTRLA reset_value) Control A */

#define DAC_CTRLA_SWRST_Pos         0            /**< \brief (DAC_CTRLA) Software Reset */
#define DAC_CTRLA_SWRST             (_Ul(0x1) << DAC_CTRLA_SWRST_Pos)
#define DAC_CTRLA_ENABLE_Pos        1            /**< \brief (DAC_CTRLA) Enable DAC Controller */
#define DAC_CTRLA_ENABLE            (_Ul(0x1) << DAC_CTRLA_ENABLE_Pos)
#define DAC_CTRLA_MASK              _Ul(0x03)     /**< \brief (DAC_CTRLA) MASK Register */
...
#define DAC_CTRLB_RESETVALUE        _Ul(0x02)     /**< \brief (DAC_CTRLB reset_value) Control B */

#define DAC_CTRLB_DIFF_Pos          0            /**< \brief (DAC_CTRLB) Differential mode enable */
#define DAC_CTRLB_DIFF              (_Ul(0x1) << DAC_CTRLB_DIFF_Pos)
#define DAC_CTRLB_REFSEL_Pos        1            /**< \brief (DAC_CTRLB) Reference Selection for DAC0/1 */
#define DAC_CTRLB_REFSEL_Msk        (_Ul(0x3) << DAC_CTRLB_REFSEL_Pos)
#define DAC_CTRLB_REFSEL(value)     (DAC_CTRLB_REFSEL_Msk & ((value) << DAC_CTRLB_REFSEL_Pos))
#define   DAC_CTRLB_REFSEL_VREFPU_Val     _Ul(0x0)   /**< \brief (DAC_CTRLB) External reference unbuffered */
#define   DAC_CTRLB_REFSEL_VDDANA_Val     _Ul(0x1)   /**< \brief (DAC_CTRLB) Analog supply */
#define   DAC_CTRLB_REFSEL_VREFPB_Val     _Ul(0x2)   /**< \brief (DAC_CTRLB) External reference buffered */
#define   DAC_CTRLB_REFSEL_INTREF_Val     _Ul(0x3)   /**< \brief (DAC_CTRLB) Internal bandgap reference */
...
#define DAC_EVCTRL_RESETVALUE       _Ul(0x00)     /**< \brief (DAC_EVCTRL reset_value) Event Control */
...
#define DAC_EVCTRL_STARTEI_Msk      (_Ul(0x3) << DAC_EVCTRL_STARTEI_Pos)
...
#define DAC_EVCTRL_EMPTYEO_Msk      (_Ul(0x3) << DAC_EVCTRL_EMPTYEO_Pos)
...
#define DAC_EVCTRL_INVEI_Msk        (_Ul(0x3) << DAC_EVCTRL_INVEI_Pos)
...
#define DAC_EVCTRL_RESRDYEO_Msk     (_Ul(0x3) << DAC_EVCTRL_RESRDYEO_Pos)
...
#define DAC_INTENCLR_RESETVALUE     _Ul(0x00)     /**< \brief (DAC_INTENCLR reset_value) Interrupt Enable Clear */
...
#define DAC_INTENCLR_UNDERRUN_Msk   (_Ul(0x3) << DAC_INTENCLR_UNDERRUN_Pos)
...
#define DAC_INTENCLR_EMPTY_Msk      (_Ul(0x3) << DAC_INTENCLR_EMPTY_Pos)
...
#define DAC_INTENCLR_RESRDY_Msk     (_Ul(0x3) << DAC_INTENCLR_RESRDY_Pos)
...
#define DAC_INTENCLR_OVERRUN_Msk    (_Ul(0x3) << DAC_INTENCLR_OVERRUN_Pos)
#define DAC_INTENCLR_OVERRUN(value) (DAC_INTENCLR_OVERRUN_Msk & ((value) << DAC_INTENCLR_OVERRUN_Pos))
#define DAC_INTENCLR_MASK           _Ul(0xFF)     /**< \brief (DAC_INTENCLR) MASK Register */
...
#define DAC_INTENSET_RESETVALUE     _Ul(0x00)     /**< \brief (DAC_INTENSET reset_value) Interrupt Enable Set */
...
#define DAC_INTENSET_EMPTY_Msk      (_Ul(0x3) << DAC_INTENSET_EMPTY_Pos)
...
#define DAC_INTENSET_RESRDY_Msk     (_Ul(0x3) << DAC_INTENSET_RESRDY_Pos)
...
#define DAC_INTENSET_OVERRUN_Msk    (_Ul(0x3) << DAC_INTENSET_OVERRUN_Pos)
...
#define DAC_INTFLAG_RESETVALUE      _Ul(0x00)     /**< \brief (DAC_INTFLAG reset_value) Interrupt Flag Status and Clear */
...
#define DAC_INTFLAG_UNDERRUN_Msk    (_Ul(0x3) << DAC_INTFLAG_UNDERRUN_Pos)
...
#define DAC_INTFLAG_EMPTY_Msk       (_Ul(0x3) << DAC_INTFLAG_EMPTY_Pos)
...
#define DAC_INTFLAG_OVERRUN_Msk     (_Ul(0x3) << DAC_INTFLAG_OVERRUN_Pos)
...
#define DAC_STATUS_RESETVALUE       _Ul(0x00)     /**< \brief (DAC_STATUS reset_value) Status */
...
#define DAC_STATUS_READY_Msk        (_Ul(0x3) << DAC_STATUS_READY_Pos)
...
#define DAC_STATUS_EOC_Msk          (_Ul(0x3) << DAC_STATUS_EOC_Pos)
...
#define DAC_SYNCBUSY_RESETVALUE     _Ul(0x00000000) /**< \brief (DAC_SYNCBUSY reset_value) Synchronization Busy */

#define DAC_SYNCBUSY_SWRST_Pos      0            /**< \brief (DAC_SYNCBUSY) Software Reset */
#define DAC_SYNCBUSY_SWRST          (_Ul(0x1) << DAC_SYNCBUSY_SWRST_Pos)
...
#define DAC_SYNCBUSY_DATA_Msk       (_Ul(0x3) << DAC_SYNCBUSY_DATA_Pos)
...
#define DAC_SYNCBUSY_DATABUF_Msk    (_Ul(0x3) << DAC_SYNCBUSY_DATABUF_Pos)
#define DAC_SYNCBUSY_DATABUF(value) (DAC_SYNCBUSY_DATABUF_Msk & ((value) << DAC_SYNCBUSY_DATABUF_Pos))
#define DAC_SYNCBUSY_MASK           _Ul(0x0000003F) /**< \brief (DAC_SYNCBUSY) MASK Register */
...
#define DAC_DACCTRL_RESETVALUE      _Ul(0x0000)   /**< \brief (DAC_DACCTRL reset_value) DAC n Control */

#define DAC_DACCTRL_LEFTADJ_Pos     0            /**< \brief (DAC_DACCTRL) Left Adjusted Data */
#define DAC_DACCTRL_LEFTADJ         (_Ul(0x1) << DAC_DACCTRL_LEFTADJ_Pos)
#define DAC_DACCTRL_ENABLE_Pos      1            /**< \brief (DAC_DACCTRL) Enable DAC0 */
#define DAC_DACCTRL_ENABLE          (_Ul(0x1) << DAC_DACCTRL_ENABLE_Pos)
#define DAC_DACCTRL_CCTRL_Pos       2            /**< \brief (DAC_DACCTRL) Current Control */
#define DAC_DACCTRL_CCTRL_Msk       (_Ul(0x3) << DAC_DACCTRL_CCTRL_Pos)
#define DAC_DACCTRL_CCTRL(value)    (DAC_DACCTRL_CCTRL_Msk & ((value) << DAC_DACCTRL_CCTRL_Pos))
#define   DAC_DACCTRL_CCTRL_CC100K_Val    _Ul(0x0)   /**< \brief (DAC_DACCTRL) GCLK_DAC ≤ 1.2MHz (100kSPS) */
#define   DAC_DACCTRL_CCTRL_CC1M_Val      _Ul(0x1)   /**< \brief (DAC_DACCTRL) 1.2MHz < GCLK_DAC  ≤ 6MHz (500kSPS) */
#define   DAC_DACCTRL_CCTRL_CC12M_Val     _Ul(0x2)   /**< \brief (DAC_DACCTRL) 6MHz < GCLK_DAC ≤ 12MHz (1MSPS) */
...
#define DAC_DACCTRL_FEXT            (_Ul(0x1) << DAC_DACCTRL_FEXT_Pos)
#define DAC_DACCTRL_RUNSTDBY_Pos    6            /**< \brief (DAC_DACCTRL) Run in Standby */
#define DAC_DACCTRL_RUNSTDBY        (_Ul(0x1) << DAC_DACCTRL_RUNSTDBY_Pos)
...
#define DAC_DACCTRL_REFRESH_Msk     (_Ul(0xF) << DAC_DACCTRL_REFRESH_Pos)
...
#define DAC_DACCTRL_OSR_Msk         (_Ul(0x7) << DAC_DACCTRL_OSR_Pos)
...
#define DAC_DATA_RESETVALUE         _Ul(0x0000)   /**< \brief (DAC_DATA reset_value) DAC n Data */

#define DAC_DATA_DATA_Pos           0            /**< \brief (DAC_DATA) DAC0 Data */
#define DAC_DATA_DATA_Msk           (_Ul(0xFFFF) << DAC_DATA_DATA_Pos)
...
#define DAC_DATABUF_RESETVALUE      _Ul(0x0000)   /**< \brief (DAC_DATABUF reset_value) DAC n Data Buffer */

#define DAC_DATABUF_DATABUF_Pos     0            /**< \brief (DAC_DATABUF) DAC0 Data Buffer */
#define DAC_DATABUF_DATABUF_Msk     (_Ul(0xFFFF) << DAC_DATABUF_DATABUF_Pos)
#define DAC_DATABUF_DATABUF(value)  (DAC_DATABUF_DATABUF_Msk & ((value) << DAC_DATABUF_DATABUF_Pos))
#define DAC_DATABUF_MASK            _Ul(0xFFFF)   /**< \brief (DAC_DATABUF) MASK Register */
...
#define DAC_DBGCTRL_RESETVALUE      _Ul(0x00)     /**< \brief (DAC_DBGCTRL reset_value) Debug Control */

#define DAC_DBGCTRL_DBGRUN_Pos      0            /**< \brief (DAC_DBGCTRL) Debug Run */
#define DAC_DBGCTRL_DBGRUN          (_Ul(0x1) << DAC_DBGCTRL_DBGRUN_Pos)
#define DAC_DBGCTRL_MASK            _Ul(0x01)     /**< \brief (DAC_DBGCTRL) MASK Register */
...
#define DAC_RESULT_RESETVALUE       _Ul(0x0000)   /**< \brief (DAC_RESULT reset_value) Filter Result */

#define DAC_RESULT_RESULT_Pos       0            /**< \brief (DAC_RESULT) Filter Result */
#define DAC_RESULT_RESULT_Msk       (_Ul(0xFFFF) << DAC_RESULT_RESULT_Pos)
#define DAC_RESULT_RESULT(value)    (DAC_RESULT_RESULT_Msk & ((value) << DAC_RESULT_RESULT_Pos))
#define DAC_RESULT_MASK             _Ul(0xFFFF)   /**< \brief (DAC_RESULT) MASK Register */
