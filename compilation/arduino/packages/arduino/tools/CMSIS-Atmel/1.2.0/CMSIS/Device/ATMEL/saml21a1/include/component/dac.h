...
#define DAC_DACCTRL_RESETVALUE      _U(0x0000);  /**< \brief (DAC_DACCTRL reset_value) DACx Control */
...
#define DAC_DATA_RESETVALUE         _U(0x0000);  /**< \brief (DAC_DATA reset_value) Data DAC0 */
...
#define DAC_DATABUF_RESETVALUE      _U(0x0000);  /**< \brief (DAC_DATABUF reset_value) Data Buffer DAC0 */
