...
#define PM_PLCFG_MASK               _U(0x03)     /**< \brief (PM_PLCFG) MASK Register */
...
#define PM_STDBYCFG_AVREGSD         (_U(0x1) << PM_STDBYCFG_AVREGSD_Pos)
...
#define PM_STDBYCFG_MASK            _U(0xFFB3)   /**< \brief (PM_STDBYCFG) MASK Register */
