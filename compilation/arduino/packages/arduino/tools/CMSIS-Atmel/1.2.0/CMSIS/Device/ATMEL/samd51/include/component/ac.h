...
#define AC_CTRLA_RESETVALUE         _Ul(0x00)     /**< \brief (AC_CTRLA reset_value) Control A */

#define AC_CTRLA_SWRST_Pos          0            /**< \brief (AC_CTRLA) Software Reset */
#define AC_CTRLA_SWRST              (_Ul(0x1) << AC_CTRLA_SWRST_Pos)
#define AC_CTRLA_ENABLE_Pos         1            /**< \brief (AC_CTRLA) Enable */
#define AC_CTRLA_ENABLE             (_Ul(0x1) << AC_CTRLA_ENABLE_Pos)
#define AC_CTRLA_MASK               _Ul(0x03)     /**< \brief (AC_CTRLA) MASK Register */
...
#define AC_CTRLB_RESETVALUE         _Ul(0x00)     /**< \brief (AC_CTRLB reset_value) Control B */
...
#define AC_CTRLB_START_Msk          (_Ul(0x3) << AC_CTRLB_START_Pos)
#define AC_CTRLB_START(value)       (AC_CTRLB_START_Msk & ((value) << AC_CTRLB_START_Pos))
#define AC_CTRLB_MASK               _Ul(0x03)     /**< \brief (AC_CTRLB) MASK Register */
...
#define AC_EVCTRL_RESETVALUE        _Ul(0x0000)   /**< \brief (AC_EVCTRL reset_value) Event Control */
...
#define AC_EVCTRL_COMPEO_Msk        (_Ul(0x3) << AC_EVCTRL_COMPEO_Pos)
...
#define AC_EVCTRL_COMPEI_Msk        (_Ul(0x3) << AC_EVCTRL_COMPEI_Pos)
...
#define AC_EVCTRL_INVEI_Msk         (_Ul(0x3) << AC_EVCTRL_INVEI_Pos)
#define AC_EVCTRL_INVEI(value)      (AC_EVCTRL_INVEI_Msk & ((value) << AC_EVCTRL_INVEI_Pos))
#define AC_EVCTRL_MASK              _Ul(0x3313)   /**< \brief (AC_EVCTRL) MASK Register */
...
#define AC_INTENCLR_RESETVALUE      _Ul(0x00)     /**< \brief (AC_INTENCLR reset_value) Interrupt Enable Clear */
...
#define AC_INTENCLR_COMP_Msk        (_Ul(0x3) << AC_INTENCLR_COMP_Pos)
...
#define AC_INTENCLR_WIN_Msk         (_Ul(0x1) << AC_INTENCLR_WIN_Pos)
...
#define AC_INTENSET_RESETVALUE      _Ul(0x00)     /**< \brief (AC_INTENSET reset_value) Interrupt Enable Set */
...
#define AC_INTENSET_COMP_Msk        (_Ul(0x3) << AC_INTENSET_COMP_Pos)
...
#define AC_INTENSET_WIN_Msk         (_Ul(0x1) << AC_INTENSET_WIN_Pos)
...
#define AC_INTFLAG_RESETVALUE       _Ul(0x00)     /**< \brief (AC_INTFLAG reset_value) Interrupt Flag Status and Clear */
...
#define AC_INTFLAG_COMP_Msk         (_Ul(0x3) << AC_INTFLAG_COMP_Pos)
...
#define AC_INTFLAG_WIN_Msk          (_Ul(0x1) << AC_INTFLAG_WIN_Pos)
...
#define AC_STATUSA_RESETVALUE       _Ul(0x00)     /**< \brief (AC_STATUSA reset_value) Status A */
...
#define AC_STATUSA_STATE_Msk        (_Ul(0x3) << AC_STATUSA_STATE_Pos)
#define AC_STATUSA_STATE(value)     (AC_STATUSA_STATE_Msk & ((value) << AC_STATUSA_STATE_Pos))
#define AC_STATUSA_WSTATE0_Pos      4            /**< \brief (AC_STATUSA) Window 0 Current State */
#define AC_STATUSA_WSTATE0_Msk      (_Ul(0x3) << AC_STATUSA_WSTATE0_Pos)
#define AC_STATUSA_WSTATE0(value)   (AC_STATUSA_WSTATE0_Msk & ((value) << AC_STATUSA_WSTATE0_Pos))
#define   AC_STATUSA_WSTATE0_ABOVE_Val    _Ul(0x0)   /**< \brief (AC_STATUSA) Signal is above window */
#define   AC_STATUSA_WSTATE0_INSIDE_Val   _Ul(0x1)   /**< \brief (AC_STATUSA) Signal is inside window */
#define   AC_STATUSA_WSTATE0_BELOW_Val    _Ul(0x2)   /**< \brief (AC_STATUSA) Signal is below window */
...
#define AC_STATUSB_RESETVALUE       _Ul(0x00)     /**< \brief (AC_STATUSB reset_value) Status B */
...
#define AC_STATUSB_READY_Msk        (_Ul(0x3) << AC_STATUSB_READY_Pos)
...
#define AC_DBGCTRL_RESETVALUE       _Ul(0x00)     /**< \brief (AC_DBGCTRL reset_value) Debug Control */

#define AC_DBGCTRL_DBGRUN_Pos       0            /**< \brief (AC_DBGCTRL) Debug Run */
#define AC_DBGCTRL_DBGRUN           (_Ul(0x1) << AC_DBGCTRL_DBGRUN_Pos)
#define AC_DBGCTRL_MASK             _Ul(0x01)     /**< \brief (AC_DBGCTRL) MASK Register */
...
#define AC_WINCTRL_RESETVALUE       _Ul(0x00)     /**< \brief (AC_WINCTRL reset_value) Window Control */

#define AC_WINCTRL_WEN0_Pos         0            /**< \brief (AC_WINCTRL) Window 0 Mode Enable */
#define AC_WINCTRL_WEN0             (_Ul(0x1) << AC_WINCTRL_WEN0_Pos)
...
#define   AC_WINCTRL_WINTSEL0_ABOVE_Val   _Ul(0x0)   /**< \brief (AC_WINCTRL) Interrupt on signal above window */
#define   AC_WINCTRL_WINTSEL0_INSIDE_Val  _Ul(0x1)   /**< \brief (AC_WINCTRL) Interrupt on signal inside window */
#define   AC_WINCTRL_WINTSEL0_BELOW_Val   _Ul(0x2)   /**< \brief (AC_WINCTRL) Interrupt on signal below window */
#define   AC_WINCTRL_WINTSEL0_OUTSIDE_Val _Ul(0x3)   /**< \brief (AC_WINCTRL) Interrupt on signal outside window */
...
#define AC_SCALER_RESETVALUE        _Ul(0x00)     /**< \brief (AC_SCALER reset_value) Scaler n */

#define AC_SCALER_VALUE_Pos         0            /**< \brief (AC_SCALER) Scaler Value */
#define AC_SCALER_VALUE_Msk         (_Ul(0x3F) << AC_SCALER_VALUE_Pos)
...
#define AC_COMPCTRL_RESETVALUE      _Ul(0x00000000) /**< \brief (AC_COMPCTRL reset_value) Comparator Control n */

#define AC_COMPCTRL_ENABLE_Pos      1            /**< \brief (AC_COMPCTRL) Enable */
#define AC_COMPCTRL_ENABLE          (_Ul(0x1) << AC_COMPCTRL_ENABLE_Pos)
#define AC_COMPCTRL_SINGLE_Pos      2            /**< \brief (AC_COMPCTRL) Single-Shot Mode */
#define AC_COMPCTRL_SINGLE          (_Ul(0x1) << AC_COMPCTRL_SINGLE_Pos)
#define AC_COMPCTRL_INTSEL_Pos      3            /**< \brief (AC_COMPCTRL) Interrupt Selection */
#define AC_COMPCTRL_INTSEL_Msk      (_Ul(0x3) << AC_COMPCTRL_INTSEL_Pos)
#define AC_COMPCTRL_INTSEL(value)   (AC_COMPCTRL_INTSEL_Msk & ((value) << AC_COMPCTRL_INTSEL_Pos))
#define   AC_COMPCTRL_INTSEL_TOGGLE_Val   _Ul(0x0)   /**< \brief (AC_COMPCTRL) Interrupt on comparator output toggle */
#define   AC_COMPCTRL_INTSEL_RISING_Val   _Ul(0x1)   /**< \brief (AC_COMPCTRL) Interrupt on comparator output rising */
#define   AC_COMPCTRL_INTSEL_FALLING_Val  _Ul(0x2)   /**< \brief (AC_COMPCTRL) Interrupt on comparator output falling */
#define   AC_COMPCTRL_INTSEL_EOC_Val      _Ul(0x3)   /**< \brief (AC_COMPCTRL) Interrupt on end of comparison (single-shot mode only) */
...
#define AC_COMPCTRL_RUNSTDBY        (_Ul(0x1) << AC_COMPCTRL_RUNSTDBY_Pos)
#define AC_COMPCTRL_MUXNEG_Pos      8            /**< \brief (AC_COMPCTRL) Negative Input Mux Selection */
#define AC_COMPCTRL_MUXNEG_Msk      (_Ul(0x7) << AC_COMPCTRL_MUXNEG_Pos)
#define AC_COMPCTRL_MUXNEG(value)   (AC_COMPCTRL_MUXNEG_Msk & ((value) << AC_COMPCTRL_MUXNEG_Pos))
#define   AC_COMPCTRL_MUXNEG_PIN0_Val     _Ul(0x0)   /**< \brief (AC_COMPCTRL) I/O pin 0 */
#define   AC_COMPCTRL_MUXNEG_PIN1_Val     _Ul(0x1)   /**< \brief (AC_COMPCTRL) I/O pin 1 */
#define   AC_COMPCTRL_MUXNEG_PIN2_Val     _Ul(0x2)   /**< \brief (AC_COMPCTRL) I/O pin 2 */
#define   AC_COMPCTRL_MUXNEG_PIN3_Val     _Ul(0x3)   /**< \brief (AC_COMPCTRL) I/O pin 3 */
#define   AC_COMPCTRL_MUXNEG_GND_Val      _Ul(0x4)   /**< \brief (AC_COMPCTRL) Ground */
#define   AC_COMPCTRL_MUXNEG_VSCALE_Val   _Ul(0x5)   /**< \brief (AC_COMPCTRL) VDD scaler */
#define   AC_COMPCTRL_MUXNEG_BANDGAP_Val  _Ul(0x6)   /**< \brief (AC_COMPCTRL) Internal bandgap voltage */
#define   AC_COMPCTRL_MUXNEG_DAC_Val      _Ul(0x7)   /**< \brief (AC_COMPCTRL) DAC output */
...
#define   AC_COMPCTRL_MUXPOS_PIN0_Val     _Ul(0x0)   /**< \brief (AC_COMPCTRL) I/O pin 0 */
#define   AC_COMPCTRL_MUXPOS_PIN1_Val     _Ul(0x1)   /**< \brief (AC_COMPCTRL) I/O pin 1 */
#define   AC_COMPCTRL_MUXPOS_PIN2_Val     _Ul(0x2)   /**< \brief (AC_COMPCTRL) I/O pin 2 */
#define   AC_COMPCTRL_MUXPOS_PIN3_Val     _Ul(0x3)   /**< \brief (AC_COMPCTRL) I/O pin 3 */
#define   AC_COMPCTRL_MUXPOS_VSCALE_Val   _Ul(0x4)   /**< \brief (AC_COMPCTRL) VDD Scaler */
...
#define AC_COMPCTRL_SPEED_Msk       (_Ul(0x3) << AC_COMPCTRL_SPEED_Pos)
#define AC_COMPCTRL_SPEED(value)    (AC_COMPCTRL_SPEED_Msk & ((value) << AC_COMPCTRL_SPEED_Pos))
#define   AC_COMPCTRL_SPEED_HIGH_Val      _Ul(0x3)   /**< \brief (AC_COMPCTRL) High speed */
...
#define AC_COMPCTRL_HYSTEN          (_Ul(0x1) << AC_COMPCTRL_HYSTEN_Pos)
#define AC_COMPCTRL_HYST_Pos        20           /**< \brief (AC_COMPCTRL) Hysteresis Level */
#define AC_COMPCTRL_HYST_Msk        (_Ul(0x3) << AC_COMPCTRL_HYST_Pos)
#define AC_COMPCTRL_HYST(value)     (AC_COMPCTRL_HYST_Msk & ((value) << AC_COMPCTRL_HYST_Pos))
#define   AC_COMPCTRL_HYST_HYST50_Val     _Ul(0x0)   /**< \brief (AC_COMPCTRL) 50mV */
#define   AC_COMPCTRL_HYST_HYST100_Val    _Ul(0x1)   /**< \brief (AC_COMPCTRL) 100mV */
#define   AC_COMPCTRL_HYST_HYST150_Val    _Ul(0x2)   /**< \brief (AC_COMPCTRL) 150mV */
...
#define AC_COMPCTRL_FLEN_Msk        (_Ul(0x7) << AC_COMPCTRL_FLEN_Pos)
#define AC_COMPCTRL_FLEN(value)     (AC_COMPCTRL_FLEN_Msk & ((value) << AC_COMPCTRL_FLEN_Pos))
#define   AC_COMPCTRL_FLEN_OFF_Val        _Ul(0x0)   /**< \brief (AC_COMPCTRL) No filtering */
#define   AC_COMPCTRL_FLEN_MAJ3_Val       _Ul(0x1)   /**< \brief (AC_COMPCTRL) 3-bit majority function (2 of 3) */
#define   AC_COMPCTRL_FLEN_MAJ5_Val       _Ul(0x2)   /**< \brief (AC_COMPCTRL) 5-bit majority function (3 of 5) */
...
#define   AC_COMPCTRL_OUT_OFF_Val         _Ul(0x0)   /**< \brief (AC_COMPCTRL) The output of COMPn is not routed to the COMPn I/O port */
#define   AC_COMPCTRL_OUT_ASYNC_Val       _Ul(0x1)   /**< \brief (AC_COMPCTRL) The asynchronous output of COMPn is routed to the COMPn I/O port */
#define   AC_COMPCTRL_OUT_SYNC_Val        _Ul(0x2)   /**< \brief (AC_COMPCTRL) The synchronous output (including filtering) of COMPn is routed to the COMPn I/O port */
...
#define AC_SYNCBUSY_RESETVALUE      _Ul(0x00000000) /**< \brief (AC_SYNCBUSY reset_value) Synchronization Busy */

#define AC_SYNCBUSY_SWRST_Pos       0            /**< \brief (AC_SYNCBUSY) Software Reset Synchronization Busy */
#define AC_SYNCBUSY_SWRST           (_Ul(0x1) << AC_SYNCBUSY_SWRST_Pos)
#define AC_SYNCBUSY_ENABLE_Pos      1            /**< \brief (AC_SYNCBUSY) Enable Synchronization Busy */
#define AC_SYNCBUSY_ENABLE          (_Ul(0x1) << AC_SYNCBUSY_ENABLE_Pos)
#define AC_SYNCBUSY_WINCTRL_Pos     2            /**< \brief (AC_SYNCBUSY) WINCTRL Synchronization Busy */
#define AC_SYNCBUSY_WINCTRL         (_Ul(0x1) << AC_SYNCBUSY_WINCTRL_Pos)
...
#define AC_SYNCBUSY_COMPCTRL_Msk    (_Ul(0x3) << AC_SYNCBUSY_COMPCTRL_Pos)
#define AC_SYNCBUSY_COMPCTRL(value) (AC_SYNCBUSY_COMPCTRL_Msk & ((value) << AC_SYNCBUSY_COMPCTRL_Pos))
#define AC_SYNCBUSY_MASK            _Ul(0x0000001F) /**< \brief (AC_SYNCBUSY) MASK Register */
...
#define AC_CALIB_RESETVALUE         _Ul(0x0101)   /**< \brief (AC_CALIB reset_value) Calibration */

#define AC_CALIB_BIAS0_Pos          0            /**< \brief (AC_CALIB) COMP0/1 Bias Scaling */
#define AC_CALIB_BIAS0_Msk          (_Ul(0x3) << AC_CALIB_BIAS0_Pos)
