...
#define OPAMP_STATUS_READY0         (_U(0x1) << OPAMP_STATUS_READY0_Pos)
#define OPAMP_STATUS_READY1_Pos     1            /**< \brief (OPAMP_STATUS) OPAMP 1 Ready */
#define OPAMP_STATUS_READY1         (_U(0x1) << OPAMP_STATUS_READY1_Pos)
#define OPAMP_STATUS_READY2_Pos     2            /**< \brief (OPAMP_STATUS) OPAMP 2 Ready */
#define OPAMP_STATUS_READY2         (_U(0x1) << OPAMP_STATUS_READY2_Pos)
...
#define OPAMP_OPAMPCTRL_RESETVALUE  _U(0x00000000); /**< \brief (OPAMP_OPAMPCTRL reset_value) OPAMP Control n */
