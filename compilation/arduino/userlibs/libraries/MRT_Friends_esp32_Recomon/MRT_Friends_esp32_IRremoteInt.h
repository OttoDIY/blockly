...
#ifndef MRT_Friends_esp32_IRremoteint_h
#define MRT_Friends_esp32_IRremoteint_h
...
/* MRT decode시 사용되는 값 */
#define MRT_BITS        10
#define MRT_HDR_MARK	600
#define MRT_HDR_SPACE	600
#define MRT_ONE_MARK	400
#define MRT_ZERO_SPACE	400
#define MRT_END_SPACE	600
#define MRT_END_MARK	600
#define MRT_RPT_LENGTH 46000
...
// MrtDuino.h에서 정의된 TOLERANCE와 충돌하여 IR_TOLERANCE로 수정.  by ljs
#define IR_TOLERANCE    25
#define LTOL            (1.0 - (IR_TOLERANCE/100.))
#define UTOL            (1.0 + (IR_TOLERANCE/100.))
...
// Teensy 2.0
	...
	//#define IR_USE_TIMER4_HS  // tx = pin 10  // use by SoftPWM, updated by ljs 2016.08.29
