...
// // TIMER2 interrupt code to collect raw data.	// 注意这个中断函数使用的是TIMER1--郭巧注释
...
// 	/**
// 	 * 右1和右2 DC马达 要使用系统默认Timer1中断来输出PWM波，
// 	 * 当使能遥控器功能后，此Timer2函数会覆盖系统默认Timer2中断函数
// 	 * 开启遥控功能后，在此处控制右1和右2 DC马达的PWM波
// 	 * */
// 	// count_speed++;
// 	// if(count_speed < motorR1Speed) {
// 	// 	digitalWrite(motorR1SpeedPin, HIGH);
// 	// } else if(count_speed <= MOTOR_SPEED_MAX) {
// 	// 	digitalWrite(motorR1SpeedPin, LOW);
// 	// } else if(count_speed > MOTOR_SPEED_MAX){
// 	// 	count_speed = 0;
// 	// }
...
// 	// if(count_speed < motorR2Speed) {
// 	// 	digitalWrite(motorR2SpeedPin, HIGH);
// 	// } else if(count_speed <= MOTOR_SPEED_MAX) {
// 	// 	digitalWrite(motorR2SpeedPin, LOW);
// 	// } else if(count_speed > MOTOR_SPEED_MAX){
// 	// 	count_speed = 0;
// 	// }
// }
